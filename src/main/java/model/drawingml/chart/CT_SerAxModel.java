...
public class CT_SerAxModel {
  ...
  public CT_SerAxModel(CT_UnsignedIntModel axId, CT_ScalingModel scaling, CT_BooleanModel delete,
      ...
      crossesOrCrossesAtModel crossesOrCrossesAt, CT_SkipModel tickLblSkip,
      CT_SkipModel tickMarkSkip, CT_ExtensionListModel extLst) {
    this.axId = axId;
