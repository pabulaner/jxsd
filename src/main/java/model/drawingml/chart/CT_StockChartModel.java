...
public class CT_StockChartModel {
  ...
  public CT_StockChartModel(List<CT_LineSerModel> ser, CT_DLblsModel dLbls,
      CT_ChartLinesModel dropLines, CT_ChartLinesModel hiLowLines, CT_UpDownBarsModel upDownBars,
