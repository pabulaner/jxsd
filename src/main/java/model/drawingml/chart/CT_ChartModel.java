...
public class CT_ChartModel {
  ...
  public CT_ChartModel(CT_TitleModel title, CT_BooleanModel autoTitleDeleted,
      CT_PivotFmtsModel pivotFmts, CT_View3DModel view3D, CT_SurfaceModel floor,
      CT_SurfaceModel sideWall, CT_SurfaceModel backWall, CT_PlotAreaModel plotArea,
      CT_LegendModel legend, CT_BooleanModel plotVisOnly, CT_DispBlanksAsModel dispBlanksAs,
      CT_BooleanModel showDLblsOverMax, CT_ExtensionListModel extLst) {
    this.title = title;
