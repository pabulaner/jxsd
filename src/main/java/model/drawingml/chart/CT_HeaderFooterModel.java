...
public class CT_HeaderFooterModel {
  ...
  public CT_HeaderFooterModel(booleanModel differentOddEven, booleanModel differentFirst,
      booleanModel alignWithMargins, ST_XstringModel oddHeader, ST_XstringModel oddFooter,
      ST_XstringModel evenHeader, ST_XstringModel evenFooter, ST_XstringModel firstHeader,
      ST_XstringModel firstFooter) {
