...
public class CT_TrendlineLblModel {
  ...
  public CT_TrendlineLblModel(CT_LayoutModel layout, CT_TxModel tx, CT_NumFmtModel numFmt,
      CT_ShapePropertiesModel spPr, CT_TextBodyModel txPr, CT_ExtensionListModel extLst) {
    this.layout = layout;
    this.tx = tx;
    this.numFmt = numFmt;
    this.spPr = spPr;
