...
import model.drawingml.main.CT_ColorMappingModel;
...
public class CT_ChartSpaceModel {
  ...
  public CT_ChartSpaceModel(CT_BooleanModel date1904, CT_TextLanguageIDModel lang,
      CT_BooleanModel roundedCorners, CT_StyleModel style, CT_ColorMappingModel clrMapOvr,
      CT_PivotSourceModel pivotSource, CT_ProtectionModel protection, CT_ChartModel chart,
      CT_ShapePropertiesModel spPr, CT_TextBodyModel txPr, CT_ExternalDataModel externalData,
      CT_PrintSettingsModel printSettings, CT_RelIdModel userShapes, CT_ExtensionListModel extLst) {
