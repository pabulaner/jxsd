...
public class CT_PictureOptionsModel {
  ...
  public CT_PictureOptionsModel(CT_BooleanModel applyToFront, CT_BooleanModel applyToSides,
      CT_BooleanModel applyToEnd, CT_PictureFormatModel pictureFormat,
      CT_PictureStackUnitModel pictureStackUnit) {
