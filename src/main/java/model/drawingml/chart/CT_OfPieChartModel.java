...
public class CT_OfPieChartModel {
  ...
  public CT_OfPieChartModel(CT_OfPieTypeModel ofPieType, CT_BooleanModel varyColors,
      List<CT_PieSerModel> ser, CT_DLblsModel dLbls, CT_GapAmountModel gapWidth,
      CT_SplitTypeModel splitType, CT_DoubleModel splitPos, CT_CustSplitModel custSplit,
      CT_SecondPieSizeModel secondPieSize, List<CT_ChartLinesModel> serLines,
