...
public class CT_SRgbColorModel {
  private final ST_HexBinary3Model val;

  private final List<tintOrShadeOrCompModel> tintOrShadeOrComp;

  public CT_SRgbColorModel(ST_HexBinary3Model val, List<tintOrShadeOrCompModel> tintOrShadeOrComp) {
    this.val = val;
    this.tintOrShadeOrComp = tintOrShadeOrComp;
  }

  public ST_HexBinary3Model getVal() {
    return this.val;
  }
