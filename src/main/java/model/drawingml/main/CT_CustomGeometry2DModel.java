...
public class CT_CustomGeometry2DModel {
  ...
  public CT_CustomGeometry2DModel(CT_GeomGuideListModel avLst, CT_GeomGuideListModel gdLst,
      CT_AdjustHandleListModel ahLst, CT_ConnectionSiteListModel cxnLst, CT_GeomRectModel rect,
      CT_Path2DListModel pathLst) {
    this.avLst = avLst;
    this.gdLst = gdLst;
    this.ahLst = ahLst;
    this.cxnLst = cxnLst;
