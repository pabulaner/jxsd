...
public class CT_TextListStyleModel {
  ...
  public CT_TextListStyleModel(CT_TextParagraphPropertiesModel defPPr,
      CT_TextParagraphPropertiesModel lvl1pPr, CT_TextParagraphPropertiesModel lvl2pPr,
      CT_TextParagraphPropertiesModel lvl3pPr, CT_TextParagraphPropertiesModel lvl4pPr,
      CT_TextParagraphPropertiesModel lvl5pPr, CT_TextParagraphPropertiesModel lvl6pPr,
      CT_TextParagraphPropertiesModel lvl7pPr, CT_TextParagraphPropertiesModel lvl8pPr,
      CT_TextParagraphPropertiesModel lvl9pPr, CT_OfficeArtExtensionListModel extLst) {
    this.defPPr = defPPr;
