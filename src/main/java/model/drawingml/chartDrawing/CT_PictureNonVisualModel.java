...
import model.drawingml.main.CT_NonVisualPicturePropertiesModel;
...
public class CT_PictureNonVisualModel {
  ...
  public CT_PictureNonVisualModel(CT_NonVisualDrawingPropsModel cNvPr,
      CT_NonVisualPicturePropertiesModel cNvPicPr) {
    this.cNvPr = cNvPr;
