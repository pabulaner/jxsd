...
public class FillStyleListBuilder {
  private List<FillStyleListModel.EG_FillProperties> egFillProperties;

  public FillStyleListBuilder() {
  }

  public FillStyleListBuilder setEGFillProperties(
      List<FillStyleListModel.EG_FillProperties> egFillProperties) {
  ...
  public static class EG_FillProperties {
    ...
    public EG_FillProperties from(FillStyleListModel.EG_FillProperties value) {
      this.type = -1;
      this.value = null;
      if (value.isNoFill()) {
        this.type = 0;
    ...
    public FillStyleListModel.EG_FillProperties build() {
      if (this.type == -1) return new FillStyleListModel.EG_FillProperties();
      if (this.type == 0) return FillStyleListModel.EG_FillProperties.newNoFill((NoFillPropertiesModel) this.value);
      if (this.type == 1) return FillStyleListModel.EG_FillProperties.newSolidFill((SolidColorFillPropertiesModel) this.value);
      if (this.type == 2) return FillStyleListModel.EG_FillProperties.newGradFill((GradientFillPropertiesModel) this.value);
      if (this.type == 3) return FillStyleListModel.EG_FillProperties.newBlipFill((BlipFillPropertiesModel) this.value);
      if (this.type == 4) return FillStyleListModel.EG_FillProperties.newPattFill((PatternFillPropertiesModel) this.value);
      if (this.type == 5) return FillStyleListModel.EG_FillProperties.newGrpFill((GroupFillPropertiesModel) this.value);
      return null;
    }
  }
}
