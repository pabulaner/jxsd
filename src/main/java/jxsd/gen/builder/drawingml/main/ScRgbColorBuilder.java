...
public class ScRgbColorBuilder {
  ...
  private List<ScRgbColorModel.EG_ColorTransform> egColorTransform;

  public ScRgbColorBuilder() {
  }

  public ScRgbColorBuilder setG(int g) {
    this.g = g;
    return this;
  }

  public ScRgbColorBuilder setR(int r) {
    this.r = r;
    return this;
  }

  public ScRgbColorBuilder setB(int b) {
    this.b = b;
    return this;
  }

  public ScRgbColorBuilder setEGColorTransform(
      List<ScRgbColorModel.EG_ColorTransform> egColorTransform) {
  ...
  public static class EG_ColorTransform {
    ...
    public EG_ColorTransform from(ScRgbColorModel.EG_ColorTransform value) {
      this.type = -1;
      this.value = null;
      if (value.isTint()) {
        this.type = 0;
    ...
    public ScRgbColorModel.EG_ColorTransform build() {
      if (this.type == -1) return new ScRgbColorModel.EG_ColorTransform();
      if (this.type == 0) return ScRgbColorModel.EG_ColorTransform.newTint((PositiveFixedPercentageModel) this.value);
      if (this.type == 1) return ScRgbColorModel.EG_ColorTransform.newShade((PositiveFixedPercentageModel) this.value);
      if (this.type == 2) return ScRgbColorModel.EG_ColorTransform.newComp((ComplementTransformModel) this.value);
      if (this.type == 3) return ScRgbColorModel.EG_ColorTransform.newInv((InverseTransformModel) this.value);
      if (this.type == 4) return ScRgbColorModel.EG_ColorTransform.newGray((GrayscaleTransformModel) this.value);
      if (this.type == 5) return ScRgbColorModel.EG_ColorTransform.newAlpha((PositiveFixedPercentageModel) this.value);
      if (this.type == 6) return ScRgbColorModel.EG_ColorTransform.newAlphaOff((FixedPercentageModel) this.value);
      if (this.type == 7) return ScRgbColorModel.EG_ColorTransform.newAlphaMod((PositivePercentageModel) this.value);
      if (this.type == 8) return ScRgbColorModel.EG_ColorTransform.newHue((PositiveFixedAngleModel) this.value);
      if (this.type == 9) return ScRgbColorModel.EG_ColorTransform.newHueOff((AngleModel) this.value);
      if (this.type == 10) return ScRgbColorModel.EG_ColorTransform.newHueMod((PositivePercentageModel) this.value);
      if (this.type == 11) return ScRgbColorModel.EG_ColorTransform.newSat((PercentageModel) this.value);
      if (this.type == 12) return ScRgbColorModel.EG_ColorTransform.newSatOff((PercentageModel) this.value);
      if (this.type == 13) return ScRgbColorModel.EG_ColorTransform.newSatMod((PercentageModel) this.value);
      if (this.type == 14) return ScRgbColorModel.EG_ColorTransform.newLum((PercentageModel) this.value);
      if (this.type == 15) return ScRgbColorModel.EG_ColorTransform.newLumOff((PercentageModel) this.value);
      if (this.type == 16) return ScRgbColorModel.EG_ColorTransform.newLumMod((PercentageModel) this.value);
      if (this.type == 17) return ScRgbColorModel.EG_ColorTransform.newRed((PercentageModel) this.value);
      if (this.type == 18) return ScRgbColorModel.EG_ColorTransform.newRedOff((PercentageModel) this.value);
      if (this.type == 19) return ScRgbColorModel.EG_ColorTransform.newRedMod((PercentageModel) this.value);
      if (this.type == 20) return ScRgbColorModel.EG_ColorTransform.newGreen((PercentageModel) this.value);
      if (this.type == 21) return ScRgbColorModel.EG_ColorTransform.newGreenOff((PercentageModel) this.value);
      if (this.type == 22) return ScRgbColorModel.EG_ColorTransform.newGreenMod((PercentageModel) this.value);
      if (this.type == 23) return ScRgbColorModel.EG_ColorTransform.newBlue((PercentageModel) this.value);
      if (this.type == 24) return ScRgbColorModel.EG_ColorTransform.newBlueOff((PercentageModel) this.value);
      if (this.type == 25) return ScRgbColorModel.EG_ColorTransform.newBlueMod((PercentageModel) this.value);
      if (this.type == 26) return ScRgbColorModel.EG_ColorTransform.newGamma((GammaTransformModel) this.value);
      if (this.type == 27) return ScRgbColorModel.EG_ColorTransform.newInvGamma((InverseGammaTransformModel) this.value);
      return null;
    }
  }
}
