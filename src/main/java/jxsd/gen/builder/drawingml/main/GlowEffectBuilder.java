...
public class GlowEffectBuilder {
  ...
  private GlowEffectModel.EG_ColorChoice egColorChoice;

  public GlowEffectBuilder() {
  }

  public GlowEffectBuilder setRad(long rad) {
    this.rad = rad;
    return this;
  }

  public GlowEffectBuilder setEGColorChoice(GlowEffectModel.EG_ColorChoice egColorChoice) {
  ...
  public static class EG_ColorChoice {
    ...
    public EG_ColorChoice from(GlowEffectModel.EG_ColorChoice value) {
      this.type = -1;
      this.value = null;
      if (value.isScrgbClr()) {
        this.type = 0;
    ...
    public GlowEffectModel.EG_ColorChoice build() {
      if (this.type == -1) return new GlowEffectModel.EG_ColorChoice();
      if (this.type == 0) return GlowEffectModel.EG_ColorChoice.newScrgbClr((ScRgbColorModel) this.value);
      if (this.type == 1) return GlowEffectModel.EG_ColorChoice.newSrgbClr((SRgbColorModel) this.value);
      if (this.type == 2) return GlowEffectModel.EG_ColorChoice.newHslClr((HslColorModel) this.value);
      if (this.type == 3) return GlowEffectModel.EG_ColorChoice.newSysClr((SystemColorModel) this.value);
      if (this.type == 4) return GlowEffectModel.EG_ColorChoice.newSchemeClr((SchemeColorModel) this.value);
      if (this.type == 5) return GlowEffectModel.EG_ColorChoice.newPrstClr((PresetColorModel) this.value);
      return null;
    }
  }
}
