...
public class SRgbColorBuilder {
  ...
  private List<SRgbColorModel.EG_ColorTransform> egColorTransform;

  public SRgbColorBuilder() {
  }

  public SRgbColorBuilder setVal(String val) {
    this.val = val;
    return this;
  }

  public SRgbColorBuilder setEGColorTransform(
      List<SRgbColorModel.EG_ColorTransform> egColorTransform) {
  ...
  public static class EG_ColorTransform {
    ...
    public EG_ColorTransform from(SRgbColorModel.EG_ColorTransform value) {
      this.type = -1;
      this.value = null;
      if (value.isTint()) {
        this.type = 0;
    ...
    public SRgbColorModel.EG_ColorTransform build() {
      if (this.type == -1) return new SRgbColorModel.EG_ColorTransform();
      if (this.type == 0) return SRgbColorModel.EG_ColorTransform.newTint((PositiveFixedPercentageModel) this.value);
      if (this.type == 1) return SRgbColorModel.EG_ColorTransform.newShade((PositiveFixedPercentageModel) this.value);
      if (this.type == 2) return SRgbColorModel.EG_ColorTransform.newComp((ComplementTransformModel) this.value);
      if (this.type == 3) return SRgbColorModel.EG_ColorTransform.newInv((InverseTransformModel) this.value);
      if (this.type == 4) return SRgbColorModel.EG_ColorTransform.newGray((GrayscaleTransformModel) this.value);
      if (this.type == 5) return SRgbColorModel.EG_ColorTransform.newAlpha((PositiveFixedPercentageModel) this.value);
      if (this.type == 6) return SRgbColorModel.EG_ColorTransform.newAlphaOff((FixedPercentageModel) this.value);
      if (this.type == 7) return SRgbColorModel.EG_ColorTransform.newAlphaMod((PositivePercentageModel) this.value);
      if (this.type == 8) return SRgbColorModel.EG_ColorTransform.newHue((PositiveFixedAngleModel) this.value);
      if (this.type == 9) return SRgbColorModel.EG_ColorTransform.newHueOff((AngleModel) this.value);
      if (this.type == 10) return SRgbColorModel.EG_ColorTransform.newHueMod((PositivePercentageModel) this.value);
      if (this.type == 11) return SRgbColorModel.EG_ColorTransform.newSat((PercentageModel) this.value);
      if (this.type == 12) return SRgbColorModel.EG_ColorTransform.newSatOff((PercentageModel) this.value);
      if (this.type == 13) return SRgbColorModel.EG_ColorTransform.newSatMod((PercentageModel) this.value);
      if (this.type == 14) return SRgbColorModel.EG_ColorTransform.newLum((PercentageModel) this.value);
      if (this.type == 15) return SRgbColorModel.EG_ColorTransform.newLumOff((PercentageModel) this.value);
      if (this.type == 16) return SRgbColorModel.EG_ColorTransform.newLumMod((PercentageModel) this.value);
      if (this.type == 17) return SRgbColorModel.EG_ColorTransform.newRed((PercentageModel) this.value);
      if (this.type == 18) return SRgbColorModel.EG_ColorTransform.newRedOff((PercentageModel) this.value);
      if (this.type == 19) return SRgbColorModel.EG_ColorTransform.newRedMod((PercentageModel) this.value);
      if (this.type == 20) return SRgbColorModel.EG_ColorTransform.newGreen((PercentageModel) this.value);
      if (this.type == 21) return SRgbColorModel.EG_ColorTransform.newGreenOff((PercentageModel) this.value);
      if (this.type == 22) return SRgbColorModel.EG_ColorTransform.newGreenMod((PercentageModel) this.value);
      if (this.type == 23) return SRgbColorModel.EG_ColorTransform.newBlue((PercentageModel) this.value);
      if (this.type == 24) return SRgbColorModel.EG_ColorTransform.newBlueOff((PercentageModel) this.value);
      if (this.type == 25) return SRgbColorModel.EG_ColorTransform.newBlueMod((PercentageModel) this.value);
      if (this.type == 26) return SRgbColorModel.EG_ColorTransform.newGamma((GammaTransformModel) this.value);
      if (this.type == 27) return SRgbColorModel.EG_ColorTransform.newInvGamma((InverseGammaTransformModel) this.value);
      return null;
    }
  }
}
