...
import jxsd.gen.builder.drawingml.main.HslColorBuilder;
...
public class HslColorModel {
  ...
  public HslColorModel(int hue, int lum, int sat, List<EG_ColorTransform> egColorTransform) {
    this.hue = hue;
    this.lum = lum;
    this.sat = sat;
  ...
  public HslColorBuilder builder() {
    return new HslColorBuilder().from(this);
  }
  ...
  public static class EG_ColorTransform {
    ...
    public HslColorBuilder.EG_ColorTransform builder() {
      return new HslColorBuilder.EG_ColorTransform().from(this);
    }
