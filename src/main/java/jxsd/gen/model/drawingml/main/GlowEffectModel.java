...
import jxsd.gen.builder.drawingml.main.GlowEffectBuilder;
...
public class GlowEffectModel {
  ...
  public GlowEffectModel(long rad, EG_ColorChoice egColorChoice) {
    this.rad = rad;
    this.egColorChoice = egColorChoice;
  }

  public GlowEffectBuilder builder() {
    return new GlowEffectBuilder().from(this);
  }
  ...
  public static class EG_ColorChoice {
    ...
    public GlowEffectBuilder.EG_ColorChoice builder() {
      return new GlowEffectBuilder.EG_ColorChoice().from(this);
    }
