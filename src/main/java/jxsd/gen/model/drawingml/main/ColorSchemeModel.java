...
import jxsd.gen.builder.drawingml.main.ColorSchemeBuilder;
...
public class ColorSchemeModel {
  ...
  public ColorSchemeModel(String name, ColorModel dk1, ColorModel lt1, ColorModel dk2,
  ...
  public ColorSchemeBuilder builder() {
    return new ColorSchemeBuilder().from(this);
  }
