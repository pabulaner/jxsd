...
import jxsd.gen.builder.drawingml.main.GradientStopBuilder;
...
public class GradientStopModel {
  ...
  public GradientStopModel(int pos, EG_ColorChoice egColorChoice) {
    this.pos = pos;
    this.egColorChoice = egColorChoice;
  }

  public GradientStopBuilder builder() {
    return new GradientStopBuilder().from(this);
  }
  ...
  public static class EG_ColorChoice {
    ...
    public GradientStopBuilder.EG_ColorChoice builder() {
      return new GradientStopBuilder.EG_ColorChoice().from(this);
    }
