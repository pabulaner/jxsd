...
import jxsd.gen.builder.drawingml.main.ColorReplaceEffectBuilder;
...
public class ColorReplaceEffectModel {
  ...
  public ColorReplaceEffectBuilder builder() {
    return new ColorReplaceEffectBuilder().from(this);
  }
