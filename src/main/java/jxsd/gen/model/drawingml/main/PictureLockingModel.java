...
import jxsd.gen.builder.drawingml.main.PictureLockingBuilder;

/**
 * This is a generated sequence class.
 */
public class PictureLockingModel {
  ...
  public PictureLockingModel(boolean noResize, boolean noChangeAspect, boolean noEditPoints,
      boolean noChangeArrowheads, boolean noCrop, boolean noSelect, boolean noGrp, boolean noMove,
      boolean noRot, boolean noChangeShapeType, boolean noAdjustHandles,
  ...
  public PictureLockingBuilder builder() {
    return new PictureLockingBuilder().from(this);
  }
