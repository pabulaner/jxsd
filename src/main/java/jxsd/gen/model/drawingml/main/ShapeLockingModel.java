...
import jxsd.gen.builder.drawingml.main.ShapeLockingBuilder;
...
public class ShapeLockingModel {
  ...
  private final boolean noTextEdit;
  ...
  public ShapeLockingModel(boolean noResize, boolean noChangeAspect, boolean noEditPoints,
      boolean noChangeArrowheads, boolean noTextEdit, boolean noSelect, boolean noGrp,
      boolean noMove, boolean noRot, boolean noChangeShapeType, boolean noAdjustHandles,
  ...
  public ShapeLockingBuilder builder() {
    return new ShapeLockingBuilder().from(this);
  }
