...
import jxsd.gen.builder.drawingml.main.PresetColorBuilder;
...
public class PresetColorModel {
  ...
  public PresetColorModel(PresetColorValValueModel val, List<EG_ColorTransform> egColorTransform) {
    this.val = val;
    this.egColorTransform = egColorTransform;
  }

  public PresetColorBuilder builder() {
    return new PresetColorBuilder().from(this);
  }
  ...
  public static class EG_ColorTransform {
    ...
    public PresetColorBuilder.EG_ColorTransform builder() {
      return new PresetColorBuilder.EG_ColorTransform().from(this);
    }
