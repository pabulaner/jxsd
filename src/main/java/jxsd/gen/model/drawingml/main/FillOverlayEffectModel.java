...
import jxsd.gen.builder.drawingml.main.FillOverlayEffectBuilder;
...
public class FillOverlayEffectModel {
  ...
  public FillOverlayEffectModel(BlendModeValueModel blend, EG_FillProperties egFillProperties) {
    this.blend = blend;
    this.egFillProperties = egFillProperties;
  }

  public FillOverlayEffectBuilder builder() {
    return new FillOverlayEffectBuilder().from(this);
  }
  ...
  public static class EG_FillProperties {
    ...
    public FillOverlayEffectBuilder.EG_FillProperties builder() {
      return new FillOverlayEffectBuilder.EG_FillProperties().from(this);
    }
