...
import jxsd.gen.builder.drawingml.main.AlphaInverseEffectBuilder;
...
public class AlphaInverseEffectModel {
  ...
  public AlphaInverseEffectBuilder builder() {
    return new AlphaInverseEffectBuilder().from(this);
  }
