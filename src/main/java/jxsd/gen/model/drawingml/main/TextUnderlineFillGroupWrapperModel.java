...
import jxsd.gen.builder.drawingml.main.TextUnderlineFillGroupWrapperBuilder;
...
public class TextUnderlineFillGroupWrapperModel {
  ...
  public TextUnderlineFillGroupWrapperBuilder builder() {
    return new TextUnderlineFillGroupWrapperBuilder().from(this);
  }
