...
import jxsd.gen.builder.drawingml.main.FontReferenceBuilder;
...
public class FontReferenceModel {
  ...
  public FontReferenceModel(FontCollectionIndexValueModel idx, EG_ColorChoice egColorChoice) {
    this.idx = idx;
    this.egColorChoice = egColorChoice;
  }

  public FontReferenceBuilder builder() {
    return new FontReferenceBuilder().from(this);
  }
  ...
  public static class EG_ColorChoice {
    ...
    public FontReferenceBuilder.EG_ColorChoice builder() {
      return new FontReferenceBuilder.EG_ColorChoice().from(this);
    }
