...
import jxsd.gen.builder.drawingml.main.DuotoneEffectBuilder;
...
public class DuotoneEffectModel {
  ...
  public DuotoneEffectModel(List<EG_ColorChoice> egColorChoice) {
    this.egColorChoice = egColorChoice;
  }

  public DuotoneEffectBuilder builder() {
    return new DuotoneEffectBuilder().from(this);
  }
  ...
  public static class EG_ColorChoice {
    ...
    public DuotoneEffectBuilder.EG_ColorChoice builder() {
      return new DuotoneEffectBuilder.EG_ColorChoice().from(this);
    }
