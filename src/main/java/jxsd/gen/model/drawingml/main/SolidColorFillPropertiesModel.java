...
import jxsd.gen.builder.drawingml.main.SolidColorFillPropertiesBuilder;
...
public class SolidColorFillPropertiesModel {
  ...
  public SolidColorFillPropertiesBuilder builder() {
    return new SolidColorFillPropertiesBuilder().from(this);
  }
