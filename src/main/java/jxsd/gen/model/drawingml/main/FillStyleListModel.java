...
import jxsd.gen.builder.drawingml.main.FillStyleListBuilder;

/**
 * This is a generated sequence class.
 */
public class FillStyleListModel {
  private final List<EG_FillProperties> egFillProperties;

  public FillStyleListModel(List<EG_FillProperties> egFillProperties) {
    this.egFillProperties = egFillProperties;
  }

  public FillStyleListBuilder builder() {
    return new FillStyleListBuilder().from(this);
  }
  ...
  public static class EG_FillProperties {
    ...
    public FillStyleListBuilder.EG_FillProperties builder() {
      return new FillStyleListBuilder.EG_FillProperties().from(this);
    }
