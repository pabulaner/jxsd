...
import jxsd.gen.builder.drawingml.main.ScRgbColorBuilder;
...
public class ScRgbColorModel {
  ...
  public ScRgbColorModel(int g, int r, int b, List<EG_ColorTransform> egColorTransform) {
    this.g = g;
    this.r = r;
    this.b = b;
  ...
  public ScRgbColorBuilder builder() {
    return new ScRgbColorBuilder().from(this);
  }
  ...
  public static class EG_ColorTransform {
    ...
    public ScRgbColorBuilder.EG_ColorTransform builder() {
      return new ScRgbColorBuilder.EG_ColorTransform().from(this);
    }
