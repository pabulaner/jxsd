...
import jxsd.gen.builder.drawingml.main.SchemeColorBuilder;
...
public class SchemeColorModel {
  ...
  public SchemeColorModel(SchemeColorValValueModel val, List<EG_ColorTransform> egColorTransform) {
    this.val = val;
    this.egColorTransform = egColorTransform;
  }

  public SchemeColorBuilder builder() {
    return new SchemeColorBuilder().from(this);
  }
  ...
  public static class EG_ColorTransform {
    ...
    public SchemeColorBuilder.EG_ColorTransform builder() {
      return new SchemeColorBuilder.EG_ColorTransform().from(this);
    }
