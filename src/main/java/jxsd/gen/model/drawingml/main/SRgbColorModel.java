...
import jxsd.gen.builder.drawingml.main.SRgbColorBuilder;
...
public class SRgbColorModel {
  ...
  public SRgbColorModel(String val, List<EG_ColorTransform> egColorTransform) {
    this.val = val;
    this.egColorTransform = egColorTransform;
  }

  public SRgbColorBuilder builder() {
    return new SRgbColorBuilder().from(this);
  }
  ...
  public static class EG_ColorTransform {
    ...
    public SRgbColorBuilder.EG_ColorTransform builder() {
      return new SRgbColorBuilder.EG_ColorTransform().from(this);
    }
