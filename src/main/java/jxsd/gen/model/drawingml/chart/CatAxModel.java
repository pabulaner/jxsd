...
import jxsd.gen.builder.drawingml.chart.CatAxBuilder;
...
public class CatAxModel {
  ...
  public CatAxBuilder builder() {
    return new CatAxBuilder().from(this);
  }
  ...
  public static class CrossesOrCrossesAt {
    ...
    public CatAxBuilder.CrossesOrCrossesAt builder() {
      return new CatAxBuilder.CrossesOrCrossesAt().from(this);
    }
