...
import jxsd.gen.builder.drawingml.chart.TrendlineBuilder;
...
public class TrendlineModel {
  ...
  public TrendlineModel(String name, ShapePropertiesModel spPr, TrendlineTypeModel trendlineType,
      OrderModel order, PeriodModel period, DoubleModel forward, DoubleModel backward,
      DoubleModel intercept, BooleanModel dispRSqr, BooleanModel dispEq,
  ...
  public TrendlineBuilder builder() {
    return new TrendlineBuilder().from(this);
  }
