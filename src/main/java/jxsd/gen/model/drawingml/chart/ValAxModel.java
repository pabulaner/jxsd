...
import jxsd.gen.builder.drawingml.chart.ValAxBuilder;
...
public class ValAxModel {
  ...
  public ValAxBuilder builder() {
    return new ValAxBuilder().from(this);
  }
  ...
  public static class CrossesOrCrossesAt {
    ...
    public ValAxBuilder.CrossesOrCrossesAt builder() {
      return new ValAxBuilder.CrossesOrCrossesAt().from(this);
    }
