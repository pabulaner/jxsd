...
import jxsd.gen.builder.drawingml.chart.Line3DChartBuilder;
...
public class Line3DChartModel {
  ...
  public Line3DChartModel(GroupingModel grouping, BooleanModel varyColors, List<LineSerModel> ser,
  ...
  public Line3DChartBuilder builder() {
    return new Line3DChartBuilder().from(this);
  }
