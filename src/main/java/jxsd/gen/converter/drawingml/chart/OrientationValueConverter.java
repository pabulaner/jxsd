...
public class OrientationValueConverter {
  ...
  public static OrientationValueModel fromDocx4j(STOrientation value) {
    ...
    if (value == OrientationValueBuilder.MAX_MIN) return OrientationValueModel.MAX_MIN;
    if (value == OrientationValueBuilder.MIN_MAX) return OrientationValueModel.MIN_MAX;
    return null;
  }

  public static STOrientation toDocx4j(OrientationValueModel value) {
    if (value == null) return null;
    if (value == OrientationValueModel.MAX_MIN) return OrientationValueBuilder.MAX_MIN;
    if (value == OrientationValueModel.MIN_MAX) return OrientationValueBuilder.MIN_MAX;
    return null;
  }
}
