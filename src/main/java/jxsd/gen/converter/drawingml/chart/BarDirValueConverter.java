...
public class BarDirValueConverter {
  ...
  public static BarDirValueModel fromDocx4j(STBarDir value) {
    ...
    if (value == BarDirValueBuilder.BAR) return BarDirValueModel.BAR;
    if (value == BarDirValueBuilder.COL) return BarDirValueModel.COL;
    return null;
  }

  public static STBarDir toDocx4j(BarDirValueModel value) {
    if (value == null) return null;
    if (value == BarDirValueModel.BAR) return BarDirValueBuilder.BAR;
    if (value == BarDirValueModel.COL) return BarDirValueBuilder.COL;
    return null;
  }
}
