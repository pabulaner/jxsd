...
public class ScRgbColorConverter {
  ...
  public static ScRgbColorModel fromDocx4j(CTScRgbColor value) {
    ...
    List<ScRgbColorModel.EG_ColorTransform> egColorTransform = value.getEGColorTransform().stream().map(val -> {
      if (val.getName().getLocalPart().equals("tint")) return ScRgbColorModel.EG_ColorTransform.newTint(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("shade")) return ScRgbColorModel.EG_ColorTransform.newShade(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("comp")) return ScRgbColorModel.EG_ColorTransform.newComp(ComplementTransformConverter.fromDocx4j((CTComplementTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("inv")) return ScRgbColorModel.EG_ColorTransform.newInv(InverseTransformConverter.fromDocx4j((CTInverseTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("gray")) return ScRgbColorModel.EG_ColorTransform.newGray(GrayscaleTransformConverter.fromDocx4j((CTGrayscaleTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("alpha")) return ScRgbColorModel.EG_ColorTransform.newAlpha(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaOff")) return ScRgbColorModel.EG_ColorTransform.newAlphaOff(FixedPercentageConverter.fromDocx4j((CTFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaMod")) return ScRgbColorModel.EG_ColorTransform.newAlphaMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("hue")) return ScRgbColorModel.EG_ColorTransform.newHue(PositiveFixedAngleConverter.fromDocx4j((CTPositiveFixedAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueOff")) return ScRgbColorModel.EG_ColorTransform.newHueOff(AngleConverter.fromDocx4j((CTAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueMod")) return ScRgbColorModel.EG_ColorTransform.newHueMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("sat")) return ScRgbColorModel.EG_ColorTransform.newSat(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satOff")) return ScRgbColorModel.EG_ColorTransform.newSatOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satMod")) return ScRgbColorModel.EG_ColorTransform.newSatMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lum")) return ScRgbColorModel.EG_ColorTransform.newLum(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumOff")) return ScRgbColorModel.EG_ColorTransform.newLumOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumMod")) return ScRgbColorModel.EG_ColorTransform.newLumMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("red")) return ScRgbColorModel.EG_ColorTransform.newRed(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redOff")) return ScRgbColorModel.EG_ColorTransform.newRedOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redMod")) return ScRgbColorModel.EG_ColorTransform.newRedMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("green")) return ScRgbColorModel.EG_ColorTransform.newGreen(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenOff")) return ScRgbColorModel.EG_ColorTransform.newGreenOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenMod")) return ScRgbColorModel.EG_ColorTransform.newGreenMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blue")) return ScRgbColorModel.EG_ColorTransform.newBlue(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueOff")) return ScRgbColorModel.EG_ColorTransform.newBlueOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueMod")) return ScRgbColorModel.EG_ColorTransform.newBlueMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("gamma")) return ScRgbColorModel.EG_ColorTransform.newGamma(GammaTransformConverter.fromDocx4j((CTGammaTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("invGamma")) return ScRgbColorModel.EG_ColorTransform.newInvGamma(InverseGammaTransformConverter.fromDocx4j((CTInverseGammaTransform) val.getValue()));
      return null;
