...
public class SchemeColorConverter {
  ...
  public static SchemeColorModel fromDocx4j(CTSchemeColor value) {
    ...
    List<SchemeColorModel.EG_ColorTransform> egColorTransform = value.getEGColorTransform().stream().map(val -> {
      if (val.getName().getLocalPart().equals("tint")) return SchemeColorModel.EG_ColorTransform.newTint(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("shade")) return SchemeColorModel.EG_ColorTransform.newShade(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("comp")) return SchemeColorModel.EG_ColorTransform.newComp(ComplementTransformConverter.fromDocx4j((CTComplementTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("inv")) return SchemeColorModel.EG_ColorTransform.newInv(InverseTransformConverter.fromDocx4j((CTInverseTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("gray")) return SchemeColorModel.EG_ColorTransform.newGray(GrayscaleTransformConverter.fromDocx4j((CTGrayscaleTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("alpha")) return SchemeColorModel.EG_ColorTransform.newAlpha(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaOff")) return SchemeColorModel.EG_ColorTransform.newAlphaOff(FixedPercentageConverter.fromDocx4j((CTFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaMod")) return SchemeColorModel.EG_ColorTransform.newAlphaMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("hue")) return SchemeColorModel.EG_ColorTransform.newHue(PositiveFixedAngleConverter.fromDocx4j((CTPositiveFixedAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueOff")) return SchemeColorModel.EG_ColorTransform.newHueOff(AngleConverter.fromDocx4j((CTAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueMod")) return SchemeColorModel.EG_ColorTransform.newHueMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("sat")) return SchemeColorModel.EG_ColorTransform.newSat(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satOff")) return SchemeColorModel.EG_ColorTransform.newSatOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satMod")) return SchemeColorModel.EG_ColorTransform.newSatMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lum")) return SchemeColorModel.EG_ColorTransform.newLum(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumOff")) return SchemeColorModel.EG_ColorTransform.newLumOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumMod")) return SchemeColorModel.EG_ColorTransform.newLumMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("red")) return SchemeColorModel.EG_ColorTransform.newRed(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redOff")) return SchemeColorModel.EG_ColorTransform.newRedOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redMod")) return SchemeColorModel.EG_ColorTransform.newRedMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("green")) return SchemeColorModel.EG_ColorTransform.newGreen(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenOff")) return SchemeColorModel.EG_ColorTransform.newGreenOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenMod")) return SchemeColorModel.EG_ColorTransform.newGreenMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blue")) return SchemeColorModel.EG_ColorTransform.newBlue(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueOff")) return SchemeColorModel.EG_ColorTransform.newBlueOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueMod")) return SchemeColorModel.EG_ColorTransform.newBlueMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("gamma")) return SchemeColorModel.EG_ColorTransform.newGamma(GammaTransformConverter.fromDocx4j((CTGammaTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("invGamma")) return SchemeColorModel.EG_ColorTransform.newInvGamma(InverseGammaTransformConverter.fromDocx4j((CTInverseGammaTransform) val.getValue()));
      return null;
