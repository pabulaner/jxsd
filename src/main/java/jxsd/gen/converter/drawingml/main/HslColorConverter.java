...
public class HslColorConverter {
  ...
  public static HslColorModel fromDocx4j(CTHslColor value) {
    ...
    List<HslColorModel.EG_ColorTransform> egColorTransform = value.getEGColorTransform().stream().map(val -> {
      if (val.getName().getLocalPart().equals("tint")) return HslColorModel.EG_ColorTransform.newTint(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("shade")) return HslColorModel.EG_ColorTransform.newShade(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("comp")) return HslColorModel.EG_ColorTransform.newComp(ComplementTransformConverter.fromDocx4j((CTComplementTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("inv")) return HslColorModel.EG_ColorTransform.newInv(InverseTransformConverter.fromDocx4j((CTInverseTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("gray")) return HslColorModel.EG_ColorTransform.newGray(GrayscaleTransformConverter.fromDocx4j((CTGrayscaleTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("alpha")) return HslColorModel.EG_ColorTransform.newAlpha(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaOff")) return HslColorModel.EG_ColorTransform.newAlphaOff(FixedPercentageConverter.fromDocx4j((CTFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaMod")) return HslColorModel.EG_ColorTransform.newAlphaMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("hue")) return HslColorModel.EG_ColorTransform.newHue(PositiveFixedAngleConverter.fromDocx4j((CTPositiveFixedAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueOff")) return HslColorModel.EG_ColorTransform.newHueOff(AngleConverter.fromDocx4j((CTAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueMod")) return HslColorModel.EG_ColorTransform.newHueMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("sat")) return HslColorModel.EG_ColorTransform.newSat(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satOff")) return HslColorModel.EG_ColorTransform.newSatOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satMod")) return HslColorModel.EG_ColorTransform.newSatMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lum")) return HslColorModel.EG_ColorTransform.newLum(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumOff")) return HslColorModel.EG_ColorTransform.newLumOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumMod")) return HslColorModel.EG_ColorTransform.newLumMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("red")) return HslColorModel.EG_ColorTransform.newRed(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redOff")) return HslColorModel.EG_ColorTransform.newRedOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redMod")) return HslColorModel.EG_ColorTransform.newRedMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("green")) return HslColorModel.EG_ColorTransform.newGreen(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenOff")) return HslColorModel.EG_ColorTransform.newGreenOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenMod")) return HslColorModel.EG_ColorTransform.newGreenMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blue")) return HslColorModel.EG_ColorTransform.newBlue(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueOff")) return HslColorModel.EG_ColorTransform.newBlueOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueMod")) return HslColorModel.EG_ColorTransform.newBlueMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("gamma")) return HslColorModel.EG_ColorTransform.newGamma(GammaTransformConverter.fromDocx4j((CTGammaTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("invGamma")) return HslColorModel.EG_ColorTransform.newInvGamma(InverseGammaTransformConverter.fromDocx4j((CTInverseGammaTransform) val.getValue()));
      return null;
