...
public class PresetColorConverter {
  ...
  public static PresetColorModel fromDocx4j(CTPresetColor value) {
    ...
    List<PresetColorModel.EG_ColorTransform> egColorTransform = value.getEGColorTransform().stream().map(val -> {
      if (val.getName().getLocalPart().equals("tint")) return PresetColorModel.EG_ColorTransform.newTint(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("shade")) return PresetColorModel.EG_ColorTransform.newShade(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("comp")) return PresetColorModel.EG_ColorTransform.newComp(ComplementTransformConverter.fromDocx4j((CTComplementTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("inv")) return PresetColorModel.EG_ColorTransform.newInv(InverseTransformConverter.fromDocx4j((CTInverseTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("gray")) return PresetColorModel.EG_ColorTransform.newGray(GrayscaleTransformConverter.fromDocx4j((CTGrayscaleTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("alpha")) return PresetColorModel.EG_ColorTransform.newAlpha(PositiveFixedPercentageConverter.fromDocx4j((CTPositiveFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaOff")) return PresetColorModel.EG_ColorTransform.newAlphaOff(FixedPercentageConverter.fromDocx4j((CTFixedPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("alphaMod")) return PresetColorModel.EG_ColorTransform.newAlphaMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("hue")) return PresetColorModel.EG_ColorTransform.newHue(PositiveFixedAngleConverter.fromDocx4j((CTPositiveFixedAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueOff")) return PresetColorModel.EG_ColorTransform.newHueOff(AngleConverter.fromDocx4j((CTAngle) val.getValue()));
      if (val.getName().getLocalPart().equals("hueMod")) return PresetColorModel.EG_ColorTransform.newHueMod(PositivePercentageConverter.fromDocx4j((CTPositivePercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("sat")) return PresetColorModel.EG_ColorTransform.newSat(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satOff")) return PresetColorModel.EG_ColorTransform.newSatOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("satMod")) return PresetColorModel.EG_ColorTransform.newSatMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lum")) return PresetColorModel.EG_ColorTransform.newLum(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumOff")) return PresetColorModel.EG_ColorTransform.newLumOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("lumMod")) return PresetColorModel.EG_ColorTransform.newLumMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("red")) return PresetColorModel.EG_ColorTransform.newRed(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redOff")) return PresetColorModel.EG_ColorTransform.newRedOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("redMod")) return PresetColorModel.EG_ColorTransform.newRedMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("green")) return PresetColorModel.EG_ColorTransform.newGreen(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenOff")) return PresetColorModel.EG_ColorTransform.newGreenOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("greenMod")) return PresetColorModel.EG_ColorTransform.newGreenMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blue")) return PresetColorModel.EG_ColorTransform.newBlue(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueOff")) return PresetColorModel.EG_ColorTransform.newBlueOff(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("blueMod")) return PresetColorModel.EG_ColorTransform.newBlueMod(PercentageConverter.fromDocx4j((CTPercentage) val.getValue()));
      if (val.getName().getLocalPart().equals("gamma")) return PresetColorModel.EG_ColorTransform.newGamma(GammaTransformConverter.fromDocx4j((CTGammaTransform) val.getValue()));
      if (val.getName().getLocalPart().equals("invGamma")) return PresetColorModel.EG_ColorTransform.newInvGamma(InverseGammaTransformConverter.fromDocx4j((CTInverseGammaTransform) val.getValue()));
      return null;
