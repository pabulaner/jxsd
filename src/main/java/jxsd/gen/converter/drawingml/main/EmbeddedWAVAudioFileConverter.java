...
public class EmbeddedWAVAudioFileConverter {
  ...
  public static EmbeddedWAVAudioFileModel fromDocx4j(CTEmbeddedWAVAudioFile value) {
    ...
    return new EmbeddedWAVAudioFileModel(RelationshipIdValueConverter.fromDocx4j(value.getEmbed()), BooleanValueConverter.fromDocx4j(value.getBuiltIn()), StringValueConverter.fromDocx4j(value.getName()));
  }
