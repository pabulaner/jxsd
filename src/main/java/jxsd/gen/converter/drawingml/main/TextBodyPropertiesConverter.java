...
public class TextBodyPropertiesConverter {
  ...
  public static TextBodyPropertiesModel fromDocx4j(CTTextBodyProperties value) {
    ...
    if (value.getNoAutofit() != null) egTextAutofit = TextBodyPropertiesConverter.newEGTextAutofit(TextBodyPropertiesConverter.fromDocx4j(value.getNoAutofit()));
    if (value.getNormAutofit() != null) egTextAutofit = TextBodyPropertiesConverter.newEGTextAutofit(TextBodyPropertiesConverter.fromDocx4j(value.getNormAutofit()));
    if (value.getSpAutoFit() != null) egTextAutofit = TextBodyPropertiesConverter.newEGTextAutofit(TextBodyPropertiesConverter.fromDocx4j(value.getSpAutoFit()));
    TextBodyPropertiesModel.EG_Text3D egText3D = new TextBodyPropertiesModel.EG_Text3D();
    if (value.getSp3D() != null) egText3D = TextBodyPropertiesConverter.newEGText3D(TextBodyPropertiesConverter.fromDocx4j(value.getSp3D()));
    if (value.getFlatTx() != null) egText3D = TextBodyPropertiesConverter.newEGText3D(TextBodyPropertiesConverter.fromDocx4j(value.getFlatTx()));
    return new TextBodyPropertiesModel(BooleanValueConverter.fromDocx4j(value.getCompatLnSpc()), TextVertOverflowTypeValueConverter.fromDocx4j(value.getVertOverflow()), Coordinate32ValueConverter.fromDocx4j(value.getBIns()), TextVerticalTypeValueConverter.fromDocx4j(value.getVert()), BooleanValueConverter.fromDocx4j(value.getAnchorCtr()), TextColumnCountValueConverter.fromDocx4j(value.getNumCol()), AngleValueConverter.fromDocx4j(value.getRot()), Coordinate32ValueConverter.fromDocx4j(value.getTIns()), Coordinate32ValueConverter.fromDocx4j(value.getLIns()), PositiveCoordinate32ValueConverter.fromDocx4j(value.getSpcCol()), TextWrappingTypeValueConverter.fromDocx4j(value.getWrap()), BooleanValueConverter.fromDocx4j(value.getFromWordArt()), BooleanValueConverter.fromDocx4j(value.getSpcFirstLastPara()), BooleanValueConverter.fromDocx4j(value.getUpright()), TextHorzOverflowTypeValueConverter.fromDocx4j(value.getHorzOverflow()), Coordinate32ValueConverter.fromDocx4j(value.getRIns()), BooleanValueConverter.fromDocx4j(value.getRtlCol()), BooleanValueConverter.fromDocx4j(value.getForceAA()), TextAnchoringTypeValueConverter.fromDocx4j(value.getAnchor()), PresetTextShapeConverter.fromDocx4j(value.getPrstTxWarp()), egTextAutofit, Scene3DConverter.fromDocx4j(value.getScene3D()), egText3D, OfficeArtExtensionListConverter.fromDocx4j(value.getExtLst()));
  }
