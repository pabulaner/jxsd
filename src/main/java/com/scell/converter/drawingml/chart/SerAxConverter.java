...
public class SerAxConverter {
  ...
  public static SerAxModel fromDocx4J(CTSerAx value) {
    ...
    SerAxModel.CrossesOrCrossesAtValueModel crossesOrCrossesAt = new SerAxModel.CrossesOrCrossesAtValueModel();
    if (value.getCrosses() != null) crossesOrCrossesAt = SerAxModel.CrossesOrCrossesAtValueModel.newCrosses(CrossesConverter.fromDocx4J(value.getCrosses()));
    if (value.getCrossesAt() != null) crossesOrCrossesAt = SerAxModel.CrossesOrCrossesAtValueModel.newCrossesAt(DoubleConverter.fromDocx4J(value.getCrossesAt()));
