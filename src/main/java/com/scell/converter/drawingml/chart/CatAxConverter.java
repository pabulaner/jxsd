...
public class CatAxConverter {
  ...
  public static CatAxModel fromDocx4J(CTCatAx value) {
    ...
    CatAxModel.CrossesOrCrossesAtValueModel crossesOrCrossesAt = new CatAxModel.CrossesOrCrossesAtValueModel();
    if (value.getCrosses() != null) crossesOrCrossesAt = CatAxModel.CrossesOrCrossesAtValueModel.newCrosses(CrossesConverter.fromDocx4J(value.getCrosses()));
    if (value.getCrossesAt() != null) crossesOrCrossesAt = CatAxModel.CrossesOrCrossesAtValueModel.newCrossesAt(DoubleConverter.fromDocx4J(value.getCrossesAt()));
