...
public class DateAxConverter {
  ...
  public static DateAxModel fromDocx4J(CTDateAx value) {
    ...
    DateAxModel.CrossesOrCrossesAtModel crossesOrCrossesAt = new DateAxModel.CrossesOrCrossesAtModel();
    if (value.getCrosses() != null) crossesOrCrossesAt = DateAxModel.CrossesOrCrossesAtModel.newCrosses(CrossesConverter.fromDocx4J(value.getCrosses()));
    if (value.getCrossesAt() != null) crossesOrCrossesAt = DateAxModel.CrossesOrCrossesAtModel.newCrossesAt(DoubleConverter.fromDocx4J(value.getCrossesAt()));
