...
public class ValAxConverter {
  ...
  public static ValAxModel fromDocx4J(CTValAx value) {
    ...
    ValAxModel.CrossesOrCrossesAtValueModel crossesOrCrossesAt = new ValAxModel.CrossesOrCrossesAtValueModel();
    if (value.getCrosses() != null) crossesOrCrossesAt = ValAxModel.CrossesOrCrossesAtValueModel.newCrosses(CrossesConverter.fromDocx4J(value.getCrosses()));
    if (value.getCrossesAt() != null) crossesOrCrossesAt = ValAxModel.CrossesOrCrossesAtValueModel.newCrossesAt(DoubleConverter.fromDocx4J(value.getCrossesAt()));
