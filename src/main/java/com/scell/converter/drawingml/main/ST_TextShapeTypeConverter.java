...
public class ST_TextShapeTypeConverter {
  ...
  public static ST_TextShapeTypeModel fromDocx4J(STTextShapeType value) {
    ...
    if (value == STTextShapeType.TEXT_WAVE_1) return ST_TextShapeTypeModel.TEXT_WAVE_1;
    if (value == STTextShapeType.TEXT_WAVE_2) return ST_TextShapeTypeModel.TEXT_WAVE_2;
    if (value == STTextShapeType.TEXT_DOUBLE_WAVE_1) return ST_TextShapeTypeModel.TEXT_DOUBLE_WAVE_1;
    if (value == STTextShapeType.TEXT_WAVE_4) return ST_TextShapeTypeModel.TEXT_WAVE_4;
