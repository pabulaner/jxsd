...
public class ST_PresetPatternValConverter {
  ...
  public static ST_PresetPatternValModel fromDocx4J(STPresetPatternVal value) {
    ...
    if (value == STPresetPatternVal.PCT_5) return ST_PresetPatternValModel.PCT_5;
    if (value == STPresetPatternVal.PCT_10) return ST_PresetPatternValModel.PCT_10;
    if (value == STPresetPatternVal.PCT_20) return ST_PresetPatternValModel.PCT_20;
    if (value == STPresetPatternVal.PCT_25) return ST_PresetPatternValModel.PCT_25;
    if (value == STPresetPatternVal.PCT_30) return ST_PresetPatternValModel.PCT_30;
    if (value == STPresetPatternVal.PCT_40) return ST_PresetPatternValModel.PCT_40;
    if (value == STPresetPatternVal.PCT_50) return ST_PresetPatternValModel.PCT_50;
    if (value == STPresetPatternVal.PCT_60) return ST_PresetPatternValModel.PCT_60;
    if (value == STPresetPatternVal.PCT_70) return ST_PresetPatternValModel.PCT_70;
    if (value == STPresetPatternVal.PCT_75) return ST_PresetPatternValModel.PCT_75;
    if (value == STPresetPatternVal.PCT_80) return ST_PresetPatternValModel.PCT_80;
    if (value == STPresetPatternVal.PCT_90) return ST_PresetPatternValModel.PCT_90;
