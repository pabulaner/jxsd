...
public class ST_PresetCameraTypeConverter {
  ...
  public static ST_PresetCameraTypeModel fromDocx4j(STPresetCameraType value) {
    ...
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS1_LEFT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS1_LEFT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS1_RIGHT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS1_RIGHT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS1_TOP) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS1_TOP;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS2_LEFT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS2_LEFT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS2_RIGHT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS2_RIGHT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS2_TOP) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS2_TOP;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS3_LEFT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS3_LEFT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS3_RIGHT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS3_RIGHT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS3_BOTTOM) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS3_BOTTOM;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS4_LEFT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS4_LEFT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS4_RIGHT) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS4_RIGHT;
    if (value == STPresetCameraType.ISOMETRIC_OFF_AXIS4_BOTTOM) return ST_PresetCameraTypeModel.ISOMETRIC_OFF_AXIS4_BOTTOM;
