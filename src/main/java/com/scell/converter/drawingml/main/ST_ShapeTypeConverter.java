...
public class ST_ShapeTypeConverter {
  ...
  public static ST_ShapeTypeModel fromDocx4J(STShapeType value) {
    ...
    if (value == STShapeType.STAR_4) return ST_ShapeTypeModel.STAR_4;
    if (value == STShapeType.STAR_5) return ST_ShapeTypeModel.STAR_5;
    if (value == STShapeType.STAR_6) return ST_ShapeTypeModel.STAR_6;
    if (value == STShapeType.STAR_7) return ST_ShapeTypeModel.STAR_7;
    if (value == STShapeType.STAR_8) return ST_ShapeTypeModel.STAR_8;
    if (value == STShapeType.STAR_10) return ST_ShapeTypeModel.STAR_10;
    if (value == STShapeType.STAR_12) return ST_ShapeTypeModel.STAR_12;
    if (value == STShapeType.STAR_16) return ST_ShapeTypeModel.STAR_16;
    if (value == STShapeType.STAR_24) return ST_ShapeTypeModel.STAR_24;
    if (value == STShapeType.STAR_32) return ST_ShapeTypeModel.STAR_32;
    if (value == STShapeType.ROUND_RECT) return ST_ShapeTypeModel.ROUND_RECT;
    if (value == STShapeType.ROUND_1_RECT) return ST_ShapeTypeModel.ROUND_1_RECT;
    if (value == STShapeType.ROUND_2_SAME_RECT) return ST_ShapeTypeModel.ROUND_2_SAME_RECT;
    if (value == STShapeType.ROUND_2_DIAG_RECT) return ST_ShapeTypeModel.ROUND_2_DIAG_RECT;
    if (value == STShapeType.SNIP_ROUND_RECT) return ST_ShapeTypeModel.SNIP_ROUND_RECT;
    if (value == STShapeType.SNIP_1_RECT) return ST_ShapeTypeModel.SNIP_1_RECT;
    if (value == STShapeType.SNIP_2_SAME_RECT) return ST_ShapeTypeModel.SNIP_2_SAME_RECT;
    if (value == STShapeType.SNIP_2_DIAG_RECT) return ST_ShapeTypeModel.SNIP_2_DIAG_RECT;
    ...
    if (value == STShapeType.IRREGULAR_SEAL_1) return ST_ShapeTypeModel.IRREGULAR_SEAL_1;
    if (value == STShapeType.IRREGULAR_SEAL_2) return ST_ShapeTypeModel.IRREGULAR_SEAL_2;
    ...
    if (value == STShapeType.STRAIGHT_CONNECTOR_1) return ST_ShapeTypeModel.STRAIGHT_CONNECTOR_1;
    if (value == STShapeType.BENT_CONNECTOR_2) return ST_ShapeTypeModel.BENT_CONNECTOR_2;
    if (value == STShapeType.BENT_CONNECTOR_3) return ST_ShapeTypeModel.BENT_CONNECTOR_3;
    if (value == STShapeType.BENT_CONNECTOR_4) return ST_ShapeTypeModel.BENT_CONNECTOR_4;
    if (value == STShapeType.BENT_CONNECTOR_5) return ST_ShapeTypeModel.BENT_CONNECTOR_5;
    if (value == STShapeType.CURVED_CONNECTOR_2) return ST_ShapeTypeModel.CURVED_CONNECTOR_2;
    if (value == STShapeType.CURVED_CONNECTOR_3) return ST_ShapeTypeModel.CURVED_CONNECTOR_3;
    if (value == STShapeType.CURVED_CONNECTOR_4) return ST_ShapeTypeModel.CURVED_CONNECTOR_4;
    if (value == STShapeType.CURVED_CONNECTOR_5) return ST_ShapeTypeModel.CURVED_CONNECTOR_5;
    if (value == STShapeType.CALLOUT_1) return ST_ShapeTypeModel.CALLOUT_1;
    if (value == STShapeType.CALLOUT_2) return ST_ShapeTypeModel.CALLOUT_2;
    if (value == STShapeType.CALLOUT_3) return ST_ShapeTypeModel.CALLOUT_3;
    if (value == STShapeType.ACCENT_CALLOUT_1) return ST_ShapeTypeModel.ACCENT_CALLOUT_1;
    if (value == STShapeType.ACCENT_CALLOUT_2) return ST_ShapeTypeModel.ACCENT_CALLOUT_2;
    if (value == STShapeType.ACCENT_CALLOUT_3) return ST_ShapeTypeModel.ACCENT_CALLOUT_3;
    if (value == STShapeType.BORDER_CALLOUT_1) return ST_ShapeTypeModel.BORDER_CALLOUT_1;
    if (value == STShapeType.BORDER_CALLOUT_2) return ST_ShapeTypeModel.BORDER_CALLOUT_2;
    if (value == STShapeType.BORDER_CALLOUT_3) return ST_ShapeTypeModel.BORDER_CALLOUT_3;
    if (value == STShapeType.ACCENT_BORDER_CALLOUT_1) return ST_ShapeTypeModel.ACCENT_BORDER_CALLOUT_1;
    if (value == STShapeType.ACCENT_BORDER_CALLOUT_2) return ST_ShapeTypeModel.ACCENT_BORDER_CALLOUT_2;
    if (value == STShapeType.ACCENT_BORDER_CALLOUT_3) return ST_ShapeTypeModel.ACCENT_BORDER_CALLOUT_3;
    ...
    if (value == STShapeType.RIBBON_2) return ST_ShapeTypeModel.RIBBON_2;
    if (value == STShapeType.ELLIPSE_RIBBON) return ST_ShapeTypeModel.ELLIPSE_RIBBON;
    if (value == STShapeType.ELLIPSE_RIBBON_2) return ST_ShapeTypeModel.ELLIPSE_RIBBON_2;
    ...
    if (value == STShapeType.GEAR_6) return ST_ShapeTypeModel.GEAR_6;
    if (value == STShapeType.GEAR_9) return ST_ShapeTypeModel.GEAR_9;
