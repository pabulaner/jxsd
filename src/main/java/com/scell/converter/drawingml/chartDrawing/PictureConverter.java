...
public class PictureConverter {
  ...
  public static PictureModel fromDocx4J(CTPicture value) {
    ...
    return new PictureModel(BooleanConverter.fromDocx4J(value.isFPublished()), StringConverter.fromDocx4J(value.getMacro()), PictureNonVisualConverter.fromDocx4J(value.getNvPicPr()), BlipFillPropertiesConverter.fromDocx4J(value.getBlipFill()), ShapePropertiesConverter.fromDocx4J(value.getSpPr()), ShapeStyleConverter.fromDocx4J(value.getStyle()));
  }
}
