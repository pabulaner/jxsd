...
public class CT_SystemColorModel {
  ...
  private final ST_HexBinary3Model lastClr;

  private final List<EG_ColorTransformModel> egColorTransform;

  public CT_SystemColorModel(ST_SystemColorValModel val, ST_HexBinary3Model lastClr,
  ...
  public ST_HexBinary3Model getLastClr() {
    return this.lastClr;
  }
