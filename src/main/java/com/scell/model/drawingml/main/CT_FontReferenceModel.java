...
public class CT_FontReferenceModel {
  private final ST_FontCollectionIndexModel idx;

  private final EG_ColorChoiceModel egColorChoice;

  public CT_FontReferenceModel(ST_FontCollectionIndexModel idx, EG_ColorChoiceModel egColorChoice) {
    this.idx = idx;
    this.egColorChoice = egColorChoice;
  }

  public ST_FontCollectionIndexModel getIdx() {
    return this.idx;
  }
