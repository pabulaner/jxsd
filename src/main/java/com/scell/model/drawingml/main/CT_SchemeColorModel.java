...
public class CT_SchemeColorModel {
  private final ST_SchemeColorValModel val;

  private final List<EG_ColorTransformModel> egColorTransform;

  public CT_SchemeColorModel(ST_SchemeColorValModel val,
      List<EG_ColorTransformModel> egColorTransform) {
    this.val = val;
    this.egColorTransform = egColorTransform;
  }

  public ST_SchemeColorValModel getVal() {
    return this.val;
  }
