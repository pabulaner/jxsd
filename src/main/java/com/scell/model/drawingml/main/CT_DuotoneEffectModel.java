...
public class CT_DuotoneEffectModel {
  private final List<EG_ColorChoiceModel> egColorChoice;

  public CT_DuotoneEffectModel(List<EG_ColorChoiceModel> egColorChoice) {
    this.egColorChoice = egColorChoice;
  }

  public List<EG_ColorChoiceModel> getEGColorChoice() {
