...
public class ConnectorLockingModel {
  ...
  public ConnectorLockingModel(BooleanValueModel noResize, BooleanValueModel noChangeAspect,
      BooleanValueModel noEditPoints, BooleanValueModel noChangeArrowheads,
      BooleanValueModel noSelect, BooleanValueModel noGrp, BooleanValueModel noMove,
      BooleanValueModel noRot, BooleanValueModel noChangeShapeType,
