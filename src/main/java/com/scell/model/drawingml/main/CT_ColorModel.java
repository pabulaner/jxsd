...
public class CT_ColorModel {
  ...
  private CT_ColorModel(Integer type, Object value) {
    this.type = type;
    this.value = value;
  }

  public static CT_ColorModel newScrgbClr(CT_ScRgbColorModel value) {
    return new CT_ColorModel(0, value);
  }
  ...
  public static CT_ColorModel newSrgbClr(CT_SRgbColorModel value) {
    return new CT_ColorModel(1, value);
  }
  ...
  public static CT_ColorModel newHslClr(CT_HslColorModel value) {
    return new CT_ColorModel(2, value);
  }
  ...
  public static CT_ColorModel newSysClr(CT_SystemColorModel value) {
    return new CT_ColorModel(3, value);
  }
  ...
  public static CT_ColorModel newSchemeClr(CT_SchemeColorModel value) {
    return new CT_ColorModel(4, value);
  }
  ...
  public static CT_ColorModel newPrstClr(CT_PresetColorModel value) {
    return new CT_ColorModel(5, value);
  }
