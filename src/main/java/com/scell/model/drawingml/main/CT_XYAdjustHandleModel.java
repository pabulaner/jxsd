...
public class CT_XYAdjustHandleModel {
  ...
  public CT_XYAdjustHandleModel(ST_AdjCoordinateModel maxX, ST_GeomGuideNameModel gdRefY,
      ST_GeomGuideNameModel gdRefX, ST_AdjCoordinateModel maxY, ST_AdjCoordinateModel minY,
      ST_AdjCoordinateModel minX, CT_AdjPoint2DModel pos) {
    this.maxX = maxX;
    this.gdRefY = gdRefY;
    this.gdRefX = gdRefX;
    this.maxY = maxY;
