...
public class CT_NonVisualConnectorPropertiesModel {
  ...
  public CT_NonVisualConnectorPropertiesModel(CT_ConnectorLockingModel cxnSpLocks,
      CT_ConnectionModel stCxn, CT_ConnectionModel endCxn, CT_OfficeArtExtensionListModel extLst) {
