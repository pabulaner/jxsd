...
public class CT_TransformEffectModel {
  ...
  public CT_TransformEffectModel(ST_PercentageModel sy, ST_FixedAngleModel ky,
      ST_PercentageModel sx, ST_CoordinateModel ty, ST_FixedAngleModel kx, ST_CoordinateModel tx) {
    this.sy = sy;
    this.ky = ky;
    this.sx = sx;
    this.ty = ty;
