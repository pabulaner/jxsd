...
public class FillStyleListModel {
  private final List<FillPropertiesModel> egFillProperties;

  public FillStyleListModel(List<FillPropertiesModel> egFillProperties) {
    this.egFillProperties = egFillProperties;
  }

  public List<FillPropertiesModel> getEGFillProperties() {
