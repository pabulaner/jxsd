...
public class CT_EffectListModel {
  ...
  public CT_EffectListModel(CT_BlurEffectModel blur, CT_FillOverlayEffectModel fillOverlay,
      CT_GlowEffectModel glow, CT_InnerShadowEffectModel innerShdw,
      CT_OuterShadowEffectModel outerShdw, CT_PresetShadowEffectModel prstShdw,
      CT_ReflectionEffectModel reflection, CT_SoftEdgesEffectModel softEdge) {
    this.blur = blur;
