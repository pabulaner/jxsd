...
public class CT_ShapeStyleModel {
  ...
  public CT_ShapeStyleModel(CT_StyleMatrixReferenceModel lnRef,
      CT_StyleMatrixReferenceModel fillRef, CT_StyleMatrixReferenceModel effectRef,
      CT_FontReferenceModel fontRef) {
    this.lnRef = lnRef;
