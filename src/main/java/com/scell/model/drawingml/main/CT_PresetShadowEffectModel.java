...
public class CT_PresetShadowEffectModel {
  ...
  public CT_PresetShadowEffectModel(ST_PositiveCoordinateModel dist, ST_PresetShadowValModel prst,
      ST_PositiveFixedAngleModel dir, ScrgbClrOrSrgbClrOrHslClrModel scrgbClrOrSrgbClrOrHslClr) {
    this.dist = dist;
    this.prst = prst;
    this.dir = dir;
