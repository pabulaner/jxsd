...
public class CT_View3DModel {
  ...
  public CT_View3DModel(CT_RotXModel rotX, CT_HPercentModel hPercent, CT_RotYModel rotY,
      CT_DepthPercentModel depthPercent, CT_BooleanModel rAngAx, CT_PerspectiveModel perspective,
