...
public class CT_ErrBarsModel {
  ...
  public CT_ErrBarsModel(CT_ErrDirModel errDir, CT_ErrBarTypeModel errBarType,
      CT_ErrValTypeModel errValType, CT_BooleanModel noEndCap, CT_NumDataSourceModel plus,
      CT_NumDataSourceModel minus, CT_DoubleModel val, CT_ShapePropertiesModel spPr,
