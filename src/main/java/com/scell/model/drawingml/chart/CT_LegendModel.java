...
public class CT_LegendModel {
  ...
  public CT_LegendModel(CT_LegendPosModel legendPos, List<CT_LegendEntryModel> legendEntry,
      CT_LayoutModel layout, CT_BooleanModel overlay, CT_ShapePropertiesModel spPr,
