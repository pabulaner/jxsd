...
public class CT_ValAxModel {
  ...
  public CT_ValAxModel(CT_UnsignedIntModel axId, CT_ScalingModel scaling, CT_BooleanModel delete,
      ...
      CrossesOrCrossesAtModel crossesOrCrossesAt, CT_CrossBetweenModel crossBetween,
      CT_AxisUnitModel majorUnit, CT_AxisUnitModel minorUnit, CT_DispUnitsModel dispUnits,
