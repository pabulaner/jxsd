...
public class CT_PieSerBuilder {
  ...
  public CT_PieSerBuilder() {
  }

  public CT_PieSerBuilder setIdx(CT_UnsignedIntModel idx) {
    this.idx = idx;
    return this;
  }

  public CT_PieSerBuilder setOrder(CT_UnsignedIntModel order) {
    this.order = order;
    return this;
  }

  public CT_PieSerBuilder setTx(CT_SerTxModel tx) {
    this.tx = tx;
    return this;
  }

  public CT_PieSerBuilder setSpPr(CT_ShapePropertiesModel spPr) {
    this.spPr = spPr;
    return this;
  }

  public CT_PieSerBuilder setExplosion(CT_UnsignedIntModel explosion) {
    this.explosion = explosion;
    return this;
  }

  public CT_PieSerBuilder setDPt(List<CT_DPtModel> dPt) {
    this.dPt = dPt;
    return this;
  }

  public CT_PieSerBuilder setDLbls(CT_DLblsModel dLbls) {
    this.dLbls = dLbls;
    return this;
  }

  public CT_PieSerBuilder setCat(CT_AxDataSourceModel cat) {
    this.cat = cat;
    return this;
  }

  public CT_PieSerBuilder setVal(CT_NumDataSourceModel val) {
    this.val = val;
    return this;
  }

  public CT_PieSerBuilder setExtLst(CT_ExtensionListModel extLst) {
    this.extLst = extLst;
    return this;
  }

  public CT_PieSerModel build() {
    return new CT_PieSerModel(this.idx, this.order, this.tx, this.spPr, this.explosion, this.dPt, this.dLbls, this.cat, this.val, this.extLst);
  }

  public CT_PieSerBuilder from(CT_PieSerModel value) {
