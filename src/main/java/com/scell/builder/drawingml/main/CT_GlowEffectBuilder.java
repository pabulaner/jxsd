...
public class CT_GlowEffectBuilder {
  ...
  private CT_GlowEffectModel.EG_ColorChoiceModel egColorChoice;
  ...
  public CT_GlowEffectBuilder setEGColorChoice(
      CT_GlowEffectModel.EG_ColorChoiceModel egColorChoice) {
    this.egColorChoice = egColorChoice;
    return this;
  }

  public CT_GlowEffectModel build() {
    return new CT_GlowEffectModel(this.rad, this.egColorChoice);
  }
  ...
  public static class EG_ColorChoiceBuilder {
    ...
    public CT_GlowEffectModel.EG_ColorChoiceModel build() {
      if (this.type == -1) return new CT_GlowEffectModel.EG_ColorChoiceModel();
      if (this.type == 0) return CT_GlowEffectModel.EG_ColorChoiceModel.newScrgbClr((CT_ScRgbColorModel) this.value);
      if (this.type == 1) return CT_GlowEffectModel.EG_ColorChoiceModel.newSrgbClr((CT_SRgbColorModel) this.value);
      if (this.type == 2) return CT_GlowEffectModel.EG_ColorChoiceModel.newHslClr((CT_HslColorModel) this.value);
      if (this.type == 3) return CT_GlowEffectModel.EG_ColorChoiceModel.newSysClr((CT_SystemColorModel) this.value);
      if (this.type == 4) return CT_GlowEffectModel.EG_ColorChoiceModel.newSchemeClr((CT_SchemeColorModel) this.value);
      if (this.type == 5) return CT_GlowEffectModel.EG_ColorChoiceModel.newPrstClr((CT_PresetColorModel) this.value);
      return null;
    }

    public EG_ColorChoiceBuilder from(CT_GlowEffectModel.EG_ColorChoiceModel value) {
      this.type = -1;
      this.value = null;
      if (value.isScrgbClr()) {
        this.type = 0;
