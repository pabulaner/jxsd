...
public class CT_TextBodyPropertiesBuilder {
  ...
  private CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel noAutofitOrNormAutofitOrSpAutoFit;

  private CT_Scene3DModel scene3d;

  private CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel sp3dOrFlatTx;
  ...
  public CT_TextBodyPropertiesBuilder setNoAutofitOrNormAutofitOrSpAutoFit(
      CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel noAutofitOrNormAutofitOrSpAutoFit) {
  ...
  public CT_TextBodyPropertiesBuilder setSp3dOrFlatTx(
      CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel sp3dOrFlatTx) {
  ...
  public CT_TextBodyPropertiesBuilder from(CT_TextBodyPropertiesModel value) {
    ...
    this.noAutofitOrNormAutofitOrSpAutoFit = value.getNoAutofitOrNormAutofitOrSpAutoFit();
    this.scene3d = value.getScene3d();
    this.sp3dOrFlatTx = value.getSp3dOrFlatTx();
    this.extLst = value.getExtLst();
    return this;
  }

  public static class NoAutofitOrNormAutofitOrSpAutoFitBuilder {
    private int type;

    private Object value;

    public NoAutofitOrNormAutofitOrSpAutoFitBuilder() {
      this.type = -1;
      this.value = null;
    }

    public NoAutofitOrNormAutofitOrSpAutoFitBuilder setNoAutofit(CT_TextNoAutofitModel value) {
      this.type = 0;
      this.value = value;
      return this;
    }

    public NoAutofitOrNormAutofitOrSpAutoFitBuilder setNormAutofit(
    ...
    public NoAutofitOrNormAutofitOrSpAutoFitBuilder setSpAutoFit(CT_TextShapeAutofitModel value) {
      this.type = 2;
      this.value = value;
      return this;
    }

    public CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel build() {
      if (this.type == -1) return new CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel();
      if (this.type == 0) return CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel.newNoAutofit((CT_TextNoAutofitModel) this.value);
      if (this.type == 1) return CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel.newNormAutofit((CT_TextNormalAutofitModel) this.value);
      if (this.type == 2) return CT_TextBodyPropertiesModel.NoAutofitOrNormAutofitOrSpAutoFitModel.newSpAutoFit((CT_TextShapeAutofitModel) this.value);
      return null;
    }

    public NoAutofitOrNormAutofitOrSpAutoFitBuilder from(
  ...
  public static class Sp3dOrFlatTxBuilder {
    private int type;

    private Object value;

    public Sp3dOrFlatTxBuilder() {
      this.type = -1;
      this.value = null;
    }

    public Sp3dOrFlatTxBuilder setSp3d(CT_Shape3DModel value) {
      this.type = 0;
      this.value = value;
      return this;
    }

    public Sp3dOrFlatTxBuilder setFlatTx(CT_FlatTextModel value) {
      this.type = 1;
      this.value = value;
      return this;
    }

    public CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel build() {
      if (this.type == -1) return new CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel();
      if (this.type == 0) return CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel.newSp3d((CT_Shape3DModel) this.value);
      if (this.type == 1) return CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel.newFlatTx((CT_FlatTextModel) this.value);
      return null;
    }

    public Sp3dOrFlatTxBuilder from(CT_TextBodyPropertiesModel.Sp3dOrFlatTxModel value) {
      this.type = -1;
      this.value = null;
      if (value.isSp3d()) {
        this.type = 0;
