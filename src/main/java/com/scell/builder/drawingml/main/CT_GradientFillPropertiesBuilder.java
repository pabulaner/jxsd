...
public class CT_GradientFillPropertiesBuilder {
  ...
  private CT_GradientFillPropertiesModel.EG_ShadePropertiesModel egShadeProperties;
  ...
  public CT_GradientFillPropertiesBuilder setEGShadeProperties(
      CT_GradientFillPropertiesModel.EG_ShadePropertiesModel egShadeProperties) {
  ...
  public CT_GradientFillPropertiesModel build() {
    return new CT_GradientFillPropertiesModel(this.rotWithShape, this.flip, this.gsLst, this.egShadeProperties, this.tileRect);
  }
  ...
  public static class EG_ShadePropertiesBuilder {
    private int type;

    private Object value;

    public EG_ShadePropertiesBuilder() {
      this.type = -1;
      this.value = null;
    }

    public EG_ShadePropertiesBuilder setLin(CT_LinearShadePropertiesModel value) {
      this.type = 0;
      this.value = value;
      return this;
    }

    public EG_ShadePropertiesBuilder setPath(CT_PathShadePropertiesModel value) {
      this.type = 1;
      this.value = value;
      return this;
    }

    public CT_GradientFillPropertiesModel.EG_ShadePropertiesModel build() {
      if (this.type == -1) return new CT_GradientFillPropertiesModel.EG_ShadePropertiesModel();
      if (this.type == 0) return CT_GradientFillPropertiesModel.EG_ShadePropertiesModel.newLin((CT_LinearShadePropertiesModel) this.value);
      if (this.type == 1) return CT_GradientFillPropertiesModel.EG_ShadePropertiesModel.newPath((CT_PathShadePropertiesModel) this.value);
      return null;
    }

    public EG_ShadePropertiesBuilder from(
        CT_GradientFillPropertiesModel.EG_ShadePropertiesModel value) {
      this.type = -1;
      this.value = null;
      if (value.isLin()) {
        this.type = 0;
