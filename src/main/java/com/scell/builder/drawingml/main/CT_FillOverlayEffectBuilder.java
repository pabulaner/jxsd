...
public class CT_FillOverlayEffectBuilder {
  ...
  private CT_FillOverlayEffectModel.EG_FillPropertiesModel egFillProperties;
  ...
  public CT_FillOverlayEffectBuilder setEGFillProperties(
      CT_FillOverlayEffectModel.EG_FillPropertiesModel egFillProperties) {
    this.egFillProperties = egFillProperties;
    return this;
  }

  public CT_FillOverlayEffectModel build() {
    return new CT_FillOverlayEffectModel(this.blend, this.egFillProperties);
  }
  ...
  public static class EG_FillPropertiesBuilder {
    ...
    public CT_FillOverlayEffectModel.EG_FillPropertiesModel build() {
      if (this.type == -1) return new CT_FillOverlayEffectModel.EG_FillPropertiesModel();
      if (this.type == 0) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newNoFill((CT_NoFillPropertiesModel) this.value);
      if (this.type == 1) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newSolidFill((CT_SolidColorFillPropertiesModel) this.value);
      if (this.type == 2) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newGradFill((CT_GradientFillPropertiesModel) this.value);
      if (this.type == 3) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newBlipFill((CT_BlipFillPropertiesModel) this.value);
      if (this.type == 4) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newPattFill((CT_PatternFillPropertiesModel) this.value);
      if (this.type == 5) return CT_FillOverlayEffectModel.EG_FillPropertiesModel.newGrpFill((CT_GroupFillPropertiesModel) this.value);
      return null;
    }

    public EG_FillPropertiesBuilder from(CT_FillOverlayEffectModel.EG_FillPropertiesModel value) {
      this.type = -1;
      this.value = null;
      if (value.isNoFill()) {
        this.type = 0;
