...
public class StyleMatrixReferenceBuilder {
  ...
  public StyleMatrixReferenceBuilder setEGColorChoice(
      StyleMatrixReferenceModel.ColorChoiceModel egColorChoice) {
  ...
  public static class ColorChoiceBuilder {
    ...
    public StyleMatrixReferenceModel.ColorChoiceModel build() {
      if (this.type == -1) return new StyleMatrixReferenceModel.ColorChoiceModel();
      if (this.type == 0) return StyleMatrixReferenceModel.ColorChoiceModel.newScrgbClr((ScRgbColorModel) this.value);
      if (this.type == 1) return StyleMatrixReferenceModel.ColorChoiceModel.newSrgbClr((SRgbColorModel) this.value);
      if (this.type == 2) return StyleMatrixReferenceModel.ColorChoiceModel.newHslClr((HslColorModel) this.value);
      if (this.type == 3) return StyleMatrixReferenceModel.ColorChoiceModel.newSysClr((SystemColorModel) this.value);
      if (this.type == 4) return StyleMatrixReferenceModel.ColorChoiceModel.newSchemeClr((SchemeColorModel) this.value);
      if (this.type == 5) return StyleMatrixReferenceModel.ColorChoiceModel.newPrstClr((PresetColorModel) this.value);
      return null;
    }

    public ColorChoiceBuilder from(StyleMatrixReferenceModel.ColorChoiceModel value) {
      this.type = -1;
      this.value = null;
      if (value.isScrgbClr()) {
        this.type = 0;
