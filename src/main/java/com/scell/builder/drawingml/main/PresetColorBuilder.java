...
public class PresetColorBuilder {
  ...
  public PresetColorBuilder setEGColorTransform(
      List<PresetColorModel.ColorTransformModel> egColorTransform) {
    this.egColorTransform = egColorTransform;
    return this;
  }

  public PresetColorModel build() {
    return new PresetColorModel(this.val, this.egColorTransform);
  }

  public PresetColorBuilder from(PresetColorModel value) {
  ...
  public static class ColorTransformBuilder {
    ...
    public PresetColorModel.ColorTransformModel build() {
      if (this.type == -1) return new PresetColorModel.ColorTransformModel();
      if (this.type == 0) return PresetColorModel.ColorTransformModel.newTint((PositiveFixedPercentageModel) this.value);
      if (this.type == 1) return PresetColorModel.ColorTransformModel.newShade((PositiveFixedPercentageModel) this.value);
      if (this.type == 2) return PresetColorModel.ColorTransformModel.newComp((ComplementTransformModel) this.value);
      if (this.type == 3) return PresetColorModel.ColorTransformModel.newInv((InverseTransformModel) this.value);
      if (this.type == 4) return PresetColorModel.ColorTransformModel.newGray((GrayscaleTransformModel) this.value);
      if (this.type == 5) return PresetColorModel.ColorTransformModel.newAlpha((PositiveFixedPercentageModel) this.value);
      if (this.type == 6) return PresetColorModel.ColorTransformModel.newAlphaOff((FixedPercentageModel) this.value);
      if (this.type == 7) return PresetColorModel.ColorTransformModel.newAlphaMod((PositivePercentageModel) this.value);
      if (this.type == 8) return PresetColorModel.ColorTransformModel.newHue((PositiveFixedAngleModel) this.value);
      if (this.type == 9) return PresetColorModel.ColorTransformModel.newHueOff((AngleModel) this.value);
      if (this.type == 10) return PresetColorModel.ColorTransformModel.newHueMod((PositivePercentageModel) this.value);
      if (this.type == 11) return PresetColorModel.ColorTransformModel.newSat((PercentageModel) this.value);
      if (this.type == 12) return PresetColorModel.ColorTransformModel.newSatOff((PercentageModel) this.value);
      if (this.type == 13) return PresetColorModel.ColorTransformModel.newSatMod((PercentageModel) this.value);
      if (this.type == 14) return PresetColorModel.ColorTransformModel.newLum((PercentageModel) this.value);
      if (this.type == 15) return PresetColorModel.ColorTransformModel.newLumOff((PercentageModel) this.value);
      if (this.type == 16) return PresetColorModel.ColorTransformModel.newLumMod((PercentageModel) this.value);
      if (this.type == 17) return PresetColorModel.ColorTransformModel.newRed((PercentageModel) this.value);
      if (this.type == 18) return PresetColorModel.ColorTransformModel.newRedOff((PercentageModel) this.value);
      if (this.type == 19) return PresetColorModel.ColorTransformModel.newRedMod((PercentageModel) this.value);
      if (this.type == 20) return PresetColorModel.ColorTransformModel.newGreen((PercentageModel) this.value);
      if (this.type == 21) return PresetColorModel.ColorTransformModel.newGreenOff((PercentageModel) this.value);
      if (this.type == 22) return PresetColorModel.ColorTransformModel.newGreenMod((PercentageModel) this.value);
      if (this.type == 23) return PresetColorModel.ColorTransformModel.newBlue((PercentageModel) this.value);
      if (this.type == 24) return PresetColorModel.ColorTransformModel.newBlueOff((PercentageModel) this.value);
      if (this.type == 25) return PresetColorModel.ColorTransformModel.newBlueMod((PercentageModel) this.value);
      if (this.type == 26) return PresetColorModel.ColorTransformModel.newGamma((GammaTransformModel) this.value);
      if (this.type == 27) return PresetColorModel.ColorTransformModel.newInvGamma((InverseGammaTransformModel) this.value);
      return null;
    }

    public ColorTransformBuilder from(PresetColorModel.ColorTransformModel value) {
      this.type = -1;
      this.value = null;
      if (value.isTint()) {
        this.type = 0;
