...
public class CT_CustomColorBuilder {
  ...
  private CT_CustomColorModel.EG_ColorChoiceModel egColorChoice;
  ...
  public CT_CustomColorBuilder setEGColorChoice(
      CT_CustomColorModel.EG_ColorChoiceModel egColorChoice) {
    this.egColorChoice = egColorChoice;
    return this;
  }

  public CT_CustomColorModel build() {
    return new CT_CustomColorModel(this.name, this.egColorChoice);
  }
  ...
  public static class EG_ColorChoiceBuilder {
    ...
    public CT_CustomColorModel.EG_ColorChoiceModel build() {
      if (this.type == -1) return new CT_CustomColorModel.EG_ColorChoiceModel();
      if (this.type == 0) return CT_CustomColorModel.EG_ColorChoiceModel.newScrgbClr((CT_ScRgbColorModel) this.value);
      if (this.type == 1) return CT_CustomColorModel.EG_ColorChoiceModel.newSrgbClr((CT_SRgbColorModel) this.value);
      if (this.type == 2) return CT_CustomColorModel.EG_ColorChoiceModel.newHslClr((CT_HslColorModel) this.value);
      if (this.type == 3) return CT_CustomColorModel.EG_ColorChoiceModel.newSysClr((CT_SystemColorModel) this.value);
      if (this.type == 4) return CT_CustomColorModel.EG_ColorChoiceModel.newSchemeClr((CT_SchemeColorModel) this.value);
      if (this.type == 5) return CT_CustomColorModel.EG_ColorChoiceModel.newPrstClr((CT_PresetColorModel) this.value);
      return null;
    }

    public EG_ColorChoiceBuilder from(CT_CustomColorModel.EG_ColorChoiceModel value) {
      this.type = -1;
      this.value = null;
      if (value.isScrgbClr()) {
        this.type = 0;
