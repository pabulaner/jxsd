...
public class SchemeColorBuilder {
  ...
  public SchemeColorBuilder setEGColorTransform(
      List<SchemeColorModel.ColorTransformModel> egColorTransform) {
    this.egColorTransform = egColorTransform;
    return this;
  }

  public SchemeColorModel build() {
    return new SchemeColorModel(this.val, this.egColorTransform);
  }

  public SchemeColorBuilder from(SchemeColorModel value) {
  ...
  public static class ColorTransformBuilder {
    ...
    public SchemeColorModel.ColorTransformModel build() {
      if (this.type == -1) return new SchemeColorModel.ColorTransformModel();
      if (this.type == 0) return SchemeColorModel.ColorTransformModel.newTint((PositiveFixedPercentageModel) this.value);
      if (this.type == 1) return SchemeColorModel.ColorTransformModel.newShade((PositiveFixedPercentageModel) this.value);
      if (this.type == 2) return SchemeColorModel.ColorTransformModel.newComp((ComplementTransformModel) this.value);
      if (this.type == 3) return SchemeColorModel.ColorTransformModel.newInv((InverseTransformModel) this.value);
      if (this.type == 4) return SchemeColorModel.ColorTransformModel.newGray((GrayscaleTransformModel) this.value);
      if (this.type == 5) return SchemeColorModel.ColorTransformModel.newAlpha((PositiveFixedPercentageModel) this.value);
      if (this.type == 6) return SchemeColorModel.ColorTransformModel.newAlphaOff((FixedPercentageModel) this.value);
      if (this.type == 7) return SchemeColorModel.ColorTransformModel.newAlphaMod((PositivePercentageModel) this.value);
      if (this.type == 8) return SchemeColorModel.ColorTransformModel.newHue((PositiveFixedAngleModel) this.value);
      if (this.type == 9) return SchemeColorModel.ColorTransformModel.newHueOff((AngleModel) this.value);
      if (this.type == 10) return SchemeColorModel.ColorTransformModel.newHueMod((PositivePercentageModel) this.value);
      if (this.type == 11) return SchemeColorModel.ColorTransformModel.newSat((PercentageModel) this.value);
      if (this.type == 12) return SchemeColorModel.ColorTransformModel.newSatOff((PercentageModel) this.value);
      if (this.type == 13) return SchemeColorModel.ColorTransformModel.newSatMod((PercentageModel) this.value);
      if (this.type == 14) return SchemeColorModel.ColorTransformModel.newLum((PercentageModel) this.value);
      if (this.type == 15) return SchemeColorModel.ColorTransformModel.newLumOff((PercentageModel) this.value);
      if (this.type == 16) return SchemeColorModel.ColorTransformModel.newLumMod((PercentageModel) this.value);
      if (this.type == 17) return SchemeColorModel.ColorTransformModel.newRed((PercentageModel) this.value);
      if (this.type == 18) return SchemeColorModel.ColorTransformModel.newRedOff((PercentageModel) this.value);
      if (this.type == 19) return SchemeColorModel.ColorTransformModel.newRedMod((PercentageModel) this.value);
      if (this.type == 20) return SchemeColorModel.ColorTransformModel.newGreen((PercentageModel) this.value);
      if (this.type == 21) return SchemeColorModel.ColorTransformModel.newGreenOff((PercentageModel) this.value);
      if (this.type == 22) return SchemeColorModel.ColorTransformModel.newGreenMod((PercentageModel) this.value);
      if (this.type == 23) return SchemeColorModel.ColorTransformModel.newBlue((PercentageModel) this.value);
      if (this.type == 24) return SchemeColorModel.ColorTransformModel.newBlueOff((PercentageModel) this.value);
      if (this.type == 25) return SchemeColorModel.ColorTransformModel.newBlueMod((PercentageModel) this.value);
      if (this.type == 26) return SchemeColorModel.ColorTransformModel.newGamma((GammaTransformModel) this.value);
      if (this.type == 27) return SchemeColorModel.ColorTransformModel.newInvGamma((InverseGammaTransformModel) this.value);
      return null;
    }

    public ColorTransformBuilder from(SchemeColorModel.ColorTransformModel value) {
      this.type = -1;
      this.value = null;
      if (value.isTint()) {
        this.type = 0;
