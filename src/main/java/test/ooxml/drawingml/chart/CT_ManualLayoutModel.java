...
import test.ooxml.drawingml.chart.CT_LayoutTargetModel;
import test.ooxml.drawingml.chart.CT_LayoutModeModel;
import test.ooxml.drawingml.chart.CT_LayoutModeModel;
import test.ooxml.drawingml.chart.CT_LayoutModeModel;
import test.ooxml.drawingml.chart.CT_LayoutModeModel;
...
public class CT_ManualLayoutModel {
    ...
    public CT_ManualLayoutModel(CT_LayoutTargetModel layoutTarget, CT_LayoutModeModel xMode, CT_LayoutModeModel yMode, CT_LayoutModeModel wMode, CT_LayoutModeModel hMode, CT_DoubleModel x, CT_DoubleModel y, CT_DoubleModel w, CT_DoubleModel h, CT_ExtensionListModel extLst) {
