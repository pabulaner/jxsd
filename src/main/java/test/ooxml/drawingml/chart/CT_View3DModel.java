...
import test.ooxml.drawingml.chart.CT_RotXModel;
import test.ooxml.drawingml.chart.CT_HPercentModel;
import test.ooxml.drawingml.chart.CT_RotYModel;
import test.ooxml.drawingml.chart.CT_DepthPercentModel;
import test.ooxml.drawingml.chart.CT_BooleanModel;
import test.ooxml.drawingml.chart.CT_PerspectiveModel;
