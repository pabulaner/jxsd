...
public class CT_DPtModel {
    ...
    public CT_DPtModel(CT_UnsignedIntModel idx, CT_BooleanModel invertIfNegative, CT_MarkerModel marker, CT_BooleanModel bubble3D, CT_UnsignedIntModel explosion, CT_ShapePropertiesModel spPr, CT_PictureOptionsModel pictureOptions, CT_ExtensionListModel extLst) {
        this.idx = idx;
