...
import test.ooxml.drawingml.chart.CT_TrendlineTypeModel;
import test.ooxml.drawingml.chart.CT_OrderModel;
import test.ooxml.drawingml.chart.CT_PeriodModel;
import test.ooxml.drawingml.chart.CT_DoubleModel;
import test.ooxml.drawingml.chart.CT_DoubleModel;
import test.ooxml.drawingml.chart.CT_DoubleModel;
import test.ooxml.drawingml.chart.CT_BooleanModel;
import test.ooxml.drawingml.chart.CT_BooleanModel;
import test.ooxml.drawingml.chart.CT_TrendlineLblModel;
