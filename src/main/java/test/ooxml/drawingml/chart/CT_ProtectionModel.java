...
public class CT_ProtectionModel {
    ...
    public CT_ProtectionModel(CT_BooleanModel chartObject, CT_BooleanModel data, CT_BooleanModel formatting, CT_BooleanModel selection, CT_BooleanModel userInterface) {
