...
public class CT_AreaSerModel {
    ...
    public CT_AreaSerModel(CT_PictureOptionsModel pictureOptions, CT_DPtModel dPt, CT_DLblsModel dLbls, CT_TrendlineModel trendline, CT_ErrBarsModel errBars, CT_AxDataSourceModel cat, CT_NumDataSourceModel val, CT_ExtensionListModel extLst) {
