...
public class CT_RadarSerModel {
    ...
    public CT_RadarSerModel(CT_MarkerModel marker, CT_DPtModel dPt, CT_DLblsModel dLbls, CT_AxDataSourceModel cat, CT_NumDataSourceModel val, CT_ExtensionListModel extLst) {
        this.marker = marker;
        this.dPt = dPt;
        this.dLbls = dLbls;
        this.cat = cat;
