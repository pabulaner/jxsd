...
import test.ooxml.drawingml.diagram.ST_IntsModel;
import test.ooxml.drawingml.diagram.ST_FunctionOperatorModel;
import test.ooxml.drawingml.diagram.ST_FunctionArgumentModel;
import test.ooxml.drawingml.diagram.ST_AxisTypesModel;
import test.ooxml.drawingml.diagram.ST_ElementTypesModel;
import test.ooxml.drawingml.diagram.ST_UnsignedIntsModel;
import test.ooxml.drawingml.diagram.ST_FunctionValueModel;
import test.ooxml.drawingml.diagram.ST_FunctionTypeModel;
import test.ooxml.drawingml.diagram.ST_BooleansModel;
...
public class AlgOrshapeOrpresOfModel {
    ...
    public CT_WhenModel(ST_IntsModel st, ST_FunctionOperatorModel op, ST_FunctionArgumentModel arg, ST_AxisTypesModel axis, ST_ElementTypesModel ptType, ST_UnsignedIntsModel cnt, ST_FunctionValueModel val, ST_FunctionTypeModel func, ST_BooleansModel hideLastTrans, StringModel name, ST_IntsModel step, AlgOrshapeOrpresOfModel algOrshapeOrpresOf) {
        this.st = st;
        this.op = op;
        this.arg = arg;
        this.axis = axis;
