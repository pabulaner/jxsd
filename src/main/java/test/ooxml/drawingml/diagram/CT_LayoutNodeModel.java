...
import test._2001.XMLSchema.StringModel;
import test.ooxml.drawingml.diagram.ST_ChildOrderTypeModel;
import test._2001.XMLSchema.StringModel;
...
import test.ooxml.drawingml.diagram.CT_LayoutVariablePropertySetModel;
...
public class AlgOrshapeOrpresOfModel {
    ...
    public CT_LayoutNodeModel(StringModel styleLbl, StringModel moveWith, ST_ChildOrderTypeModel chOrder, StringModel name, AlgOrshapeOrpresOfModel algOrshapeOrpresOf) {
