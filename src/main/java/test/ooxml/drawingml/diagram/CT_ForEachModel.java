...
public class AlgOrshapeOrpresOfModel {
    ...
    public CT_ForEachModel(ST_IntsModel st, ST_AxisTypesModel axis, ST_ElementTypesModel ptType, ST_UnsignedIntsModel cnt, StringModel ref, ST_BooleansModel hideLastTrans, StringModel name, ST_IntsModel step, AlgOrshapeOrpresOfModel algOrshapeOrpresOf) {
        this.st = st;
        this.axis = axis;
        this.ptType = ptType;
        this.cnt = cnt;
