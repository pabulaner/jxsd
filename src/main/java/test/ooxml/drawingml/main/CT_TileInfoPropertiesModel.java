...
public class CT_TileInfoPropertiesModel {
    ...
    public CT_TileInfoPropertiesModel(ST_PercentageModel sy, ST_CoordinateModel ty, ST_PercentageModel sx, ST_TileFlipModeModel flip, ST_CoordinateModel tx, ST_RectAlignmentModel algn) {
        this.sy = sy;
        this.ty = ty;
        this.sx = sx;
        this.flip = flip;
