...
import test.ooxml.drawingml.main.ST_ColorSchemeIndexModel;
import test.ooxml.drawingml.main.ST_ColorSchemeIndexModel;
import test.ooxml.drawingml.main.ST_ColorSchemeIndexModel;
import test.ooxml.drawingml.main.ST_ColorSchemeIndexModel;
import test.ooxml.drawingml.main.ST_ColorSchemeIndexModel;
...
public class CT_ColorMappingModel {
    ...
    public CT_ColorMappingModel(ST_ColorSchemeIndexModel tx1, ST_ColorSchemeIndexModel accent3, ST_ColorSchemeIndexModel accent2, ST_ColorSchemeIndexModel hlink, ST_ColorSchemeIndexModel accent1, ST_ColorSchemeIndexModel folHlink, ST_ColorSchemeIndexModel accent6, ST_ColorSchemeIndexModel bg2, ST_ColorSchemeIndexModel accent5, ST_ColorSchemeIndexModel bg1, ST_ColorSchemeIndexModel tx2, ST_ColorSchemeIndexModel accent4, CT_OfficeArtExtensionListModel extLst) {
        this.tx1 = tx1;
