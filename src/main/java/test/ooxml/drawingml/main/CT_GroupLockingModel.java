...
public class CT_GroupLockingModel {
    ...
    public CT_GroupLockingModel(BooleanModel noResize, BooleanModel noChangeAspect, BooleanModel noSelect, BooleanModel noUngrp, BooleanModel noGrp, BooleanModel noMove, BooleanModel noRot, CT_OfficeArtExtensionListModel extLst) {
