...
import test.ooxml.drawingml.main.ST_PositiveFixedPercentageModel;
...
public class CT_ReflectionEffectModel {
    ...
    public CT_ReflectionEffectModel(ST_PositiveCoordinateModel blurRad, ST_PositiveFixedPercentageModel endPos, ST_PercentageModel sy, ST_FixedAngleModel kx, ST_PositiveFixedPercentageModel stA, ST_PositiveFixedPercentageModel stPos, ST_RectAlignmentModel algn, ST_PositiveCoordinateModel dist, BooleanModel rotWithShape, ST_FixedAngleModel ky, ST_PositiveFixedAngleModel fadeDir, ST_PercentageModel sx, ST_PositiveFixedAngleModel dir, ST_PositiveFixedPercentageModel endA) {
