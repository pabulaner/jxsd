...
// SEQUENCE CONVERTER
public class CTShapeLockingConverter
{
	
	private CTShapeLockingConverter() {
		// empty
	}
	
	public static CTShapeLockingModel fromDocx4j(CTShapeLocking value)
	{
		return new CTShapeLockingModel(
		...
		,
		BooleanConverter.fromDocx4j(value.getNoTextEdit())
		,
