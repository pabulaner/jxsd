...
import test.drawingml.main.CTSchemeColorModel.TintOrShadeOrCompModel.*;
import test.XMLSchema.*;
import org.docx4j.dml.*;
import test.drawingml.main.*;
import org.docx4j.dml.chartDrawing.*;
import test.drawingml.main.CTSchemeColorModel.*;
import test.drawingml.chartDrawing.*;
import test.officeDocument.relationships.*;

// SEQUENCE CONVERTER
public class CTSchemeColorConverter
{
	...
	private CTSchemeColorConverter() {
		// empty
	}
	
	public static CTSchemeColorModel fromDocx4j(CTSchemeColor value)
	{
		return new CTSchemeColorModel(
		STSchemeColorValConverter.fromDocx4j(value.getVal())
		,
