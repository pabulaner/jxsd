...
import test.drawingml.main.CTGlowEffectModel.*;
import test.drawingml.chart.*;
import test.XMLSchema.*;
import test.drawingml.main.CTGlowEffectModel.ScrgbClrOrSrgbClrOrHslClrModel.*;
...
// SEQUENCE CONVERTER
public class CTGlowEffectConverter
{
	...
	private CTGlowEffectConverter() {
		// empty
	}
	
	public static CTGlowEffectModel fromDocx4j(CTGlowEffect value)
	{
		return new CTGlowEffectModel(
