...
public class CTBackgroundFillStyleListConverter
{
	...
	{
		if (value.getNoFill() != null) return CTBackgroundFillStyleListModel.createNoFill(
		...
		if (value.getGradFill() != null) return CTBackgroundFillStyleListModel.createGradFill(
		CTGradientFillPropertiesConverter.fromDocx4j(value.getGradFill())
		);
		if (value.getBlipFill() != null) return CTBackgroundFillStyleListModel.createBlipFill(
		CTBlipFillPropertiesConverter.fromDocx4j(value.getBlipFill())
		);
		if (value.getPattFill() != null) return CTBackgroundFillStyleListModel.createPattFill(
		CTPatternFillPropertiesConverter.fromDocx4j(value.getPattFill())
		);
		if (value.getGrpFill() != null) return CTBackgroundFillStyleListModel.createGrpFill(
