...
public class CTReflectionEffectModel {
  ...
  public CTReflectionEffectModel(STPositiveCoordinateModel blurRad,
      STPositiveFixedPercentageModel endPos, STPercentageModel sy, STFixedAngleModel kx,
      STPositiveFixedPercentageModel stA, STPositiveFixedPercentageModel stPos,
      STRectAlignmentModel algn, STPositiveCoordinateModel dist, BooleanModel rotWithShape,
      STFixedAngleModel ky, STPositiveFixedAngleModel fadeDir, STPercentageModel sx,
      STPositiveFixedAngleModel dir, STPositiveFixedPercentageModel endA) {
