...
import test.drawingml.main.CTSRgbColorModel.*;
...
import test.drawingml.main.CTSRgbColorModel.TintOrShadeOrCompModel.*;

// SEQUENCE CONVERTER
public class CTSRgbColorConverter
{
	...
	private CTSRgbColorConverter() {
		// empty
	}
	
	public static CTSRgbColorModel fromDocx4j(CTSRgbColor value)
	{
		return new CTSRgbColorModel(
		STHexBinary3Converter.fromDocx4j(value.getVal())
		,
