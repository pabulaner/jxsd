...
public class CTColorMRUModel
{
	...
	private CTColorMRUModel(int type, Object value) {
		this.type = type;
		this.value = value;
	}
	
	public static CTColorMRUModel createScrgbClr(CTScRgbColorModel value) {
		return new CTColorMRUModel(0, value);
	}
	public static CTColorMRUModel createSrgbClr(CTSRgbColorModel value) {
		return new CTColorMRUModel(1, value);
	}
	public static CTColorMRUModel createHslClr(CTHslColorModel value) {
		return new CTColorMRUModel(2, value);
	}
	public static CTColorMRUModel createSysClr(CTSystemColorModel value) {
		return new CTColorMRUModel(3, value);
	}
	public static CTColorMRUModel createSchemeClr(CTSchemeColorModel value) {
		return new CTColorMRUModel(4, value);
	}
	public static CTColorMRUModel createPrstClr(CTPresetColorModel value) {
