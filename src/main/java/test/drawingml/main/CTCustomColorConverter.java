...
import test.drawingml.main.CTCustomColorModel.ScrgbClrOrSrgbClrOrHslClrModel.*;
import test.XMLSchema.*;
import org.docx4j.dml.*;
import test.drawingml.main.*;
import org.docx4j.dml.chartDrawing.*;
import test.drawingml.chartDrawing.*;
import test.drawingml.main.CTCustomColorModel.*;
import test.officeDocument.relationships.*;

// SEQUENCE CONVERTER
public class CTCustomColorConverter
{
	...
	private CTCustomColorConverter() {
		// empty
	}
	
	public static CTCustomColorModel fromDocx4j(CTCustomColor value)
	{
		return new CTCustomColorModel(
