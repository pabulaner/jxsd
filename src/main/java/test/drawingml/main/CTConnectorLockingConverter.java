...
// SEQUENCE CONVERTER
public class CTConnectorLockingConverter
{
	
	private CTConnectorLockingConverter() {
		// empty
	}
	
	public static CTConnectorLockingModel fromDocx4j(CTConnectorLocking value)
	{
		return new CTConnectorLockingModel(
