...
// SEQUENCE CONVERTER
public class CTScRgbColorConverter
{
	...
	private CTScRgbColorConverter() {
		// empty
	}
	
	public static CTScRgbColorModel fromDocx4j(CTScRgbColor value)
	{
		return new CTScRgbColorModel(
		STPercentageConverter.fromDocx4j(value.getG())
		,
