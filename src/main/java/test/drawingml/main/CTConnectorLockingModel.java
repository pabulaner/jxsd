...
import test.drawingml.main.CTConnectorLockingModel.*;
...
// SEQUENCE MODEL
public class CTConnectorLockingModel
{
	...
	public CTConnectorLockingModel(BooleanModel noResize, BooleanModel noChangeAspect, BooleanModel noEditPoints, BooleanModel noChangeArrowheads, BooleanModel noSelect, BooleanModel noGrp, BooleanModel noMove, BooleanModel noRot, BooleanModel noChangeShapeType, BooleanModel noAdjustHandles, CTOfficeArtExtensionListModel extLst) {
