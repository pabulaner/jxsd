...
import test.drawingml.main.CTShapeLockingModel.*;
...
// SEQUENCE MODEL
public class CTShapeLockingModel
{
	...
	public CTShapeLockingModel(BooleanModel noResize, BooleanModel noChangeAspect, BooleanModel noEditPoints, BooleanModel noChangeArrowheads, BooleanModel noTextEdit, BooleanModel noSelect, BooleanModel noGrp, BooleanModel noMove, BooleanModel noRot, BooleanModel noChangeShapeType, BooleanModel noAdjustHandles, CTOfficeArtExtensionListModel extLst) {
