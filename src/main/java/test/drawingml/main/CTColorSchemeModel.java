...
public class CTColorSchemeModel {
  ...
  public CTColorSchemeModel(StringModel name, CTColorModel dk1, CTColorModel lt1, CTColorModel dk2,
      CTColorModel lt2, CTColorModel accent1, CTColorModel accent2, CTColorModel accent3,
      CTColorModel accent4, CTColorModel accent5, CTColorModel accent6, CTColorModel hlink,
      CTColorModel folHlink, CTOfficeArtExtensionListModel extLst) {
    this.name = name;
    this.dk1 = dk1;
    this.lt1 = lt1;
    this.dk2 = dk2;
