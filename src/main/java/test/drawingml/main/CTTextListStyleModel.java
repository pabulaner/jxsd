...
public class CTTextListStyleModel {
  ...
  public CTTextListStyleModel(CTTextParagraphPropertiesModel defPPr,
      CTTextParagraphPropertiesModel lvl1pPr, CTTextParagraphPropertiesModel lvl2pPr,
      CTTextParagraphPropertiesModel lvl3pPr, CTTextParagraphPropertiesModel lvl4pPr,
      CTTextParagraphPropertiesModel lvl5pPr, CTTextParagraphPropertiesModel lvl6pPr,
      CTTextParagraphPropertiesModel lvl7pPr, CTTextParagraphPropertiesModel lvl8pPr,
      CTTextParagraphPropertiesModel lvl9pPr, CTOfficeArtExtensionListModel extLst) {
    this.defPPr = defPPr;
