...
public class CTColorModel
{
	...
	private CTColorModel(int type, Object value) {
		this.type = type;
		this.value = value;
	}
	
	public static CTColorModel createScrgbClr(CTScRgbColorModel value) {
		return new CTColorModel(0, value);
	}
	public static CTColorModel createSrgbClr(CTSRgbColorModel value) {
		return new CTColorModel(1, value);
	}
	public static CTColorModel createHslClr(CTHslColorModel value) {
		return new CTColorModel(2, value);
	}
	public static CTColorModel createSysClr(CTSystemColorModel value) {
		return new CTColorModel(3, value);
	}
	public static CTColorModel createSchemeClr(CTSchemeColorModel value) {
		return new CTColorModel(4, value);
	}
	public static CTColorModel createPrstClr(CTPresetColorModel value) {
