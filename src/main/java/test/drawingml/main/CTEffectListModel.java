...
public class CTEffectListModel {
  ...
  public CTEffectListModel(CTBlurEffectModel blur, CTFillOverlayEffectModel fillOverlay,
      CTGlowEffectModel glow, CTInnerShadowEffectModel innerShdw,
      CTOuterShadowEffectModel outerShdw, CTPresetShadowEffectModel prstShdw,
      CTReflectionEffectModel reflection, CTSoftEdgesEffectModel softEdge) {
    this.blur = blur;
