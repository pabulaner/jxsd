...
public class CTXYAdjustHandleModel {
  ...
  public CTXYAdjustHandleModel(STAdjCoordinateModel maxX, STGeomGuideNameModel gdRefY,
      STGeomGuideNameModel gdRefX, STAdjCoordinateModel maxY, STAdjCoordinateModel minY,
      STAdjCoordinateModel minX, CTAdjPoint2DModel pos) {
    this.maxX = maxX;
    this.gdRefY = gdRefY;
    this.gdRefX = gdRefX;
    this.maxY = maxY;
