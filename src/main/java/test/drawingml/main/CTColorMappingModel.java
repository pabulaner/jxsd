...
public class CTColorMappingModel {
  ...
  public CTColorMappingModel(STColorSchemeIndexModel tx1, STColorSchemeIndexModel accent3,
      STColorSchemeIndexModel accent2, STColorSchemeIndexModel hlink,
      STColorSchemeIndexModel accent1, STColorSchemeIndexModel folHlink,
      STColorSchemeIndexModel accent6, STColorSchemeIndexModel bg2, STColorSchemeIndexModel accent5,
      STColorSchemeIndexModel bg1, STColorSchemeIndexModel tx2, STColorSchemeIndexModel accent4,
