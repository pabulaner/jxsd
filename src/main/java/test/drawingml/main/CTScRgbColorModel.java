...
import test.drawingml.main.CTScRgbColorModel.*;
import test.drawingml.chart.*;
import test.drawingml.main.CTScRgbColorModel.TintOrShadeOrCompModel.*;
...
// SEQUENCE MODEL
public class CTScRgbColorModel
{
	...
	private final STPercentageModel g;
	...
	public CTScRgbColorModel(STPercentageModel g, STPercentageModel r, STPercentageModel b, List<TintOrShadeOrCompModel> tintOrShadeOrComp) {
		this.g = g;
		this.r = r;
		this.b = b;
