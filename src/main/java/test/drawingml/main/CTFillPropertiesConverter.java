...
public class CTFillPropertiesConverter
{
	...
	{
		if (value.getNoFill() != null) return CTFillPropertiesModel.createNoFill(
		...
		if (value.getGradFill() != null) return CTFillPropertiesModel.createGradFill(
		CTGradientFillPropertiesConverter.fromDocx4j(value.getGradFill())
		);
		if (value.getBlipFill() != null) return CTFillPropertiesModel.createBlipFill(
		CTBlipFillPropertiesConverter.fromDocx4j(value.getBlipFill())
		);
		if (value.getPattFill() != null) return CTFillPropertiesModel.createPattFill(
		CTPatternFillPropertiesConverter.fromDocx4j(value.getPattFill())
		);
		if (value.getGrpFill() != null) return CTFillPropertiesModel.createGrpFill(
