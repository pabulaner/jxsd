...
import test.drawingml.main.CTTextFieldModel.*;
...
public class CTTextFieldModel
{
	...
	public CTTextFieldModel(StringModel type, STGuidModel id, CTTextCharacterPropertiesModel rPr, CTTextParagraphPropertiesModel pPr, StringModel t) {
		this.type = type;
		this.id = id;
		this.rPr = rPr;
		this.pPr = pPr;
