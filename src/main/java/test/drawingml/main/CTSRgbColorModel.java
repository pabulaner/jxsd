...
public class CTSRgbColorModel
{
	...
	private final STHexBinary3Model val;
	private final List<TintOrShadeOrCompModel> tintOrShadeOrComp;
	
	public CTSRgbColorModel(STHexBinary3Model val, List<TintOrShadeOrCompModel> tintOrShadeOrComp) {
		this.val = val;
		this.tintOrShadeOrComp = tintOrShadeOrComp;
	}
	
	public STHexBinary3Model getVal() {
		return this.val;
	}
