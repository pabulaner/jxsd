...
// SEQUENCE MODEL
public class CTSystemColorModel
{
	...
	private final STSystemColorValModel val;
	private final STHexBinary3Model lastClr;
	private final List<TintOrShadeOrCompModel> tintOrShadeOrComp;
	
	public CTSystemColorModel(STSystemColorValModel val, STHexBinary3Model lastClr, List<TintOrShadeOrCompModel> tintOrShadeOrComp) {
		this.val = val;
		this.lastClr = lastClr;
		this.tintOrShadeOrComp = tintOrShadeOrComp;
	}
	
	public STSystemColorValModel getVal() {
		return this.val;
	}
	public STHexBinary3Model getLastClr() {
		return this.lastClr;
	}
