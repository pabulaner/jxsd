...
public class CTShapeModel {
  ...
  public CTShapeModel(BooleanModel fPublished, StringModel macro, BooleanModel fLocksText,
      StringModel textlink, CTShapeNonVisualModel nvSpPr, CTShapePropertiesModel spPr,
      CTShapeStyleModel style, CTTextBodyModel txBody) {
