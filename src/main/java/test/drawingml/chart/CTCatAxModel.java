...
public class CTCatAxModel {
  ...
  public CTCatAxModel(CTUnsignedIntModel axId, CTScalingModel scaling, CTBooleanModel delete,
      ...
      CTBooleanModel auto, CTLblAlgnModel lblAlgn, CTLblOffsetModel lblOffset,
      CTSkipModel tickLblSkip, CTSkipModel tickMarkSkip, CTBooleanModel noMultiLvlLbl,
