...
import test.drawingml.chart.CTLine3DChartModel.*;
...
public class CTLine3DChartModel
{
	...
	public CTLine3DChartModel(CTGroupingModel grouping, CTBooleanModel varyColors, List<CTLineSerModel> ser, CTDLblsModel dLbls, CTChartLinesModel dropLines, CTGapAmountModel gapDepth, List<CTUnsignedIntModel> axId, CTExtensionListModel extLst) {
