...
public class CTTrendlineModel {
  ...
  public CTTrendlineModel(StringModel name, CTShapePropertiesModel spPr,
      CTTrendlineTypeModel trendlineType, CTOrderModel order, CTPeriodModel period,
      CTDoubleModel forward, CTDoubleModel backward, CTDoubleModel intercept,
      CTBooleanModel dispRSqr, CTBooleanModel dispEq, CTTrendlineLblModel trendlineLbl,
