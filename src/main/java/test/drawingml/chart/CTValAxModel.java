...
public class CTValAxModel {
  ...
  public CTValAxModel(CTUnsignedIntModel axId, CTScalingModel scaling, CTBooleanModel delete,
      ...
      CTCrossBetweenModel crossBetween, CTAxisUnitModel majorUnit, CTAxisUnitModel minorUnit,
      CTDispUnitsModel dispUnits, CTExtensionListModel extLst) {
    this.axId = axId;
