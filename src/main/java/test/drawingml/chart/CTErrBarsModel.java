...
public class CTErrBarsModel {
  ...
  public CTErrBarsModel(CTErrDirModel errDir, CTErrBarTypeModel errBarType,
      CTErrValTypeModel errValType, CTBooleanModel noEndCap, CTNumDataSourceModel plus,
      CTNumDataSourceModel minus, CTDoubleModel val, CTShapePropertiesModel spPr,
