...
public class CTBarSerModel {
  ...
  public CTBarSerModel(CTUnsignedIntModel idx, CTUnsignedIntModel order, CTSerTxModel tx,
      CTShapePropertiesModel spPr, CTBooleanModel invertIfNegative,
      CTPictureOptionsModel pictureOptions, CTDPtModel dPt, CTDLblsModel dLbls,
      CTTrendlineModel trendline, CTErrBarsModel errBars, CTAxDataSourceModel cat,
      CTNumDataSourceModel val, CTShapeModel shape, CTExtensionListModel extLst) {
    this.idx = idx;
    this.order = order;
    this.tx = tx;
    this.spPr = spPr;
