...
import test.drawingml.chart.CTScatterSerModel.*;
...
// SEQUENCE CONVERTER
public class CTScatterSerConverter
{
	
	private CTScatterSerConverter() {
		// empty
	}
	
	public static CTScatterSerModel fromDocx4j(CTScatterSer value)
	{
		return new CTScatterSerModel(
