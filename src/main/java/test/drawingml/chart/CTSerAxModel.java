...
public class CTSerAxModel {
  ...
  public CTSerAxModel(CTUnsignedIntModel axId, CTScalingModel scaling, CTBooleanModel delete,
      ...
      CTSkipModel tickLblSkip, CTSkipModel tickMarkSkip, CTExtensionListModel extLst) {
    this.axId = axId;
