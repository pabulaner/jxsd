...
public class CTChartModel {
  ...
  public CTChartModel(CTTitleModel title, CTBooleanModel autoTitleDeleted,
      CTPivotFmtsModel pivotFmts, CTView3DModel view3D, CTSurfaceModel floor,
      CTSurfaceModel sideWall, CTSurfaceModel backWall, CTPlotAreaModel plotArea,
      CTLegendModel legend, CTBooleanModel plotVisOnly, CTDispBlanksAsModel dispBlanksAs,
      CTBooleanModel showDLblsOverMax, CTExtensionListModel extLst) {
    this.title = title;
