...
public class CTHeaderFooterModel {
  ...
  public CTHeaderFooterModel(BooleanModel differentOddEven, BooleanModel differentFirst,
      BooleanModel alignWithMargins, STXstringModel oddHeader, STXstringModel oddFooter,
      STXstringModel evenHeader, STXstringModel evenFooter, STXstringModel firstHeader,
      STXstringModel firstFooter) {
