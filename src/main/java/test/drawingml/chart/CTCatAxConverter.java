...
import test.drawingml.chart.CTCatAxModel.*;
import test.drawingml.chart.CTCatAxModel.CrossesOrCrossesAtModel.*;
import test.officeDocument.relationships.*;

// SEQUENCE CONVERTER
public class CTCatAxConverter
{
	...
	private CTCatAxConverter() {
		// empty
	}
	
	public static CTCatAxModel fromDocx4j(CTCatAx value)
	{
		return new CTCatAxModel(
		...
		,
		CTLblAlgnConverter.fromDocx4j(value.getLblAlgn())
		,
		...
		,
		CTBooleanConverter.fromDocx4j(value.getNoMultiLvlLbl())
		,
