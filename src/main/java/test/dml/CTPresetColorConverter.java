...
public class CTPresetColorConverter
{
	
	public static class TintOrShadeOrCompConverter
	{
		
		private CTPresetColorConverter() {
			// empty
		}
		
		public static CTPresetColorModel fromDocx4j(CTPresetColor value)
		{
	...
	public static CTPresetColorModel fromDocx4j(CTPresetColor value)
	{
		return new CTPresetColorModel(
		STPresetColorValConverter.fromDocx4j(value.getVal())
		,
