...
public class CTLineSerModel
{
	...
	public CTLineSerModel(CTUnsignedIntModel idx, CTUnsignedIntModel order, CTSerTxModel tx, CTShapePropertiesModel spPr, CTMarkerModel marker, List<CTDPtModel> dPt, CTDLblsModel dLbls, List<CTTrendlineModel> trendline, CTErrBarsModel errBars, CTAxDataSourceModel cat, CTNumDataSourceModel val, CTBooleanModel smooth, CTExtensionListModel extLst) {
		this.idx = idx;
		this.order = order;
		this.tx = tx;
		this.spPr = spPr;
