...
public class CTSurface3DChartModel
{
	...
	public CTSurface3DChartModel(CTBooleanModel wireframe, List<CTSurfaceSerModel> ser, CTBandFmtsModel bandFmts, List<CTUnsignedIntModel> axId, CTExtensionListModel extLst) {
