...
public class CTPieSerModel
{
	...
	public CTPieSerModel(CTUnsignedIntModel idx, CTUnsignedIntModel order, CTSerTxModel tx, CTShapePropertiesModel spPr, CTUnsignedIntModel explosion, List<CTDPtModel> dPt, CTDLblsModel dLbls, CTAxDataSourceModel cat, CTNumDataSourceModel val, CTExtensionListModel extLst) {
		this.idx = idx;
		this.order = order;
		this.tx = tx;
		this.spPr = spPr;
