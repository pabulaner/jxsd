...
public class CTColorModel
{
	...
	public CTColorModel(CTScRgbColorModel value) {
		this.value = value;
	}
	public CTColorModel(CTSRgbColorModel value) {
		this.value = value;
	}
	public CTColorModel(CTHslColorModel value) {
		this.value = value;
	}
	public CTColorModel(CTSystemColorModel value) {
		this.value = value;
	}
	public CTColorModel(CTSchemeColorModel value) {
		this.value = value;
	}
	public CTColorModel(CTPresetColorModel value) {
		this.value = value;
	}
