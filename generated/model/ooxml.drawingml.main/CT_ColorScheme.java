...
public class CT_ColorSchemeModel {
    ...
    public CT_ColorSchemeModel(StringModel name , CT_ColorModel dk1 , CT_ColorModel lt1 , CT_ColorModel dk2 , CT_ColorModel lt2 , CT_ColorModel accent1 , CT_ColorModel accent2 , CT_ColorModel accent3 , CT_ColorModel accent4 , CT_ColorModel accent5 , CT_ColorModel accent6 , CT_ColorModel hlink , CT_ColorModel folHlink , CT_OfficeArtExtensionListModel extLst ) {
        this.name = name;
        this.dk1 = dk1;
        this.lt1 = lt1;
        this.dk2 = dk2;
