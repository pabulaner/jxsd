...
public class CT_BubbleChartModel {
    ...
    public CT_BubbleChartModel(CT_BooleanModel varyColors , List<CT_BubbleSerModel> ser , CT_DLblsModel dLbls , CT_BooleanModel bubble3D , CT_BubbleScaleModel bubbleScale , CT_BooleanModel showNegBubbles , CT_SizeRepresentsModel sizeRepresents , List<CT_UnsignedIntModel> axId , CT_ExtensionListModel extLst ) {
