...
public class CT_LineChartModel {
    ...
    public CT_LineChartModel(CT_ChartLinesModel hiLowLines , CT_UpDownBarsModel upDownBars , CT_BooleanModel marker , CT_BooleanModel smooth , List<CT_UnsignedIntModel> axId , CT_ExtensionListModel extLst ) {
