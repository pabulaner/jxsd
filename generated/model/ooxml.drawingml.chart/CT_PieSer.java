...
public class CT_PieSerModel {
    ...
    public CT_PieSerModel(CT_UnsignedIntModel explosion , List<CT_DPtModel> dPt , CT_DLblsModel dLbls , CT_AxDataSourceModel cat , CT_NumDataSourceModel val , CT_ExtensionListModel extLst ) {
