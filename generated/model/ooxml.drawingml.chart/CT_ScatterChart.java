...
public class CT_ScatterChartModel {
    ...
    public CT_ScatterChartModel(CT_ScatterStyleModel scatterStyle , CT_BooleanModel varyColors , List<CT_ScatterSerModel> ser , CT_DLblsModel dLbls , List<CT_UnsignedIntModel> axId , CT_ExtensionListModel extLst ) {
