...
public class CT_PivotFmtModel {
    ...
    public CT_PivotFmtModel(CT_UnsignedIntModel idx , CT_ShapePropertiesModel spPr , CT_TextBodyModel txPr , CT_MarkerModel marker , CT_DLblModel dLbl , CT_ExtensionListModel extLst ) {
        this.idx = idx;
        this.spPr = spPr;
        this.txPr = txPr;
        this.marker = marker;
