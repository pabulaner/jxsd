...
public class CT_RadarChartModel {
    ...
    public CT_RadarChartModel(CT_RadarStyleModel radarStyle , CT_BooleanModel varyColors , List<CT_RadarSerModel> ser , CT_DLblsModel dLbls , List<CT_UnsignedIntModel> axId , CT_ExtensionListModel extLst ) {
